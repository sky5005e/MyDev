...
public class Meschinowellness_M1MyWellnessReport {
	WebDriver d;
	...
	private void validateLinkAndRelatedPage(String sectionName, int sectionIndex, int elementIndex,
		...
		if (checktext) {
			List<String> Verifytextlist = new ArrayList<>(Arrays.asList("Introduction to Your Dietary Assessment",
					...
					"Based upon your responses", "40.00.", "Your frequent consumption of whole eggs is of some concern",
					...
					"Your Body Mass Index is: 62.69", "This places you in the Grade 3 overweight category.",
					"Your present waist circumference is", "38.",
					...
					"You indicated that a rst degree relative sustained a heart attack before age 60.",
					...
					"Coenzyme Q10 and Hawthorn Supplement", "Immune and Detoxification Support",
					"Brain and Memory Support Nutrients", "PSA Blood Test:", "Colonoscopy:"));
