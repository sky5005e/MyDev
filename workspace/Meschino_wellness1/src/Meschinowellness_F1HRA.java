...
public class Meschinowellness_F1HRA {
		...
		public void MyHraTab() throws Exception {
			...
			dropdown.selectByVisibleText("275");
			Thread.sleep(5000);
...
//			GetQuestionValue.put("Q182", 1);
			 GetQuestionValue.put("Q183",0);
			 GetQuestionValue.put("Q184",0);
			 GetQuestionValue.put("Q185",0);
			 GetQuestionValue.put("Q186",0);
			 GetQuestionValue.put("Q187",0);
			 GetQuestionValue.put("Q188",0);
			 GetQuestionValue.put("Q189",0);
			 GetQuestionValue.put("Q190",0);
			 GetQuestionValue.put("Q191",0);
			 GetQuestionValue.put("Q192",0);
