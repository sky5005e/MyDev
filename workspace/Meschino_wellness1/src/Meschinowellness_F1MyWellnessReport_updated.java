	...
	public static Map<String, List<String>> EXPECTED_STRINGS = new HashMap<String, List<String>>();
	{
		...
		EXPECTED_STRINGS.put("Physical Activity_Strong",
				Arrays.asList("Endurance / Aerobic Activity",
						...
						"In your particular case, your protein requirement would be approximately 137 grams per day.",
		...
		EXPECTED_STRINGS.put("Nutrient Deficiencies and Depletion of Nutrients_Strong", 
				Arrays.asList("Nutrient Deficiencies and Depletion of Nutrients",
						...
						"Your regular use of amphetamines is associated with depletion of Vitamin B12",
						...
						"Your regular use of an anti-gout drug is associated with depletion of the following nutrients:",
						"Stress"));
		...
		EXPECTED_STRINGS.put("Family Health History_Links",
				Arrays.asList("http://demo-meschinowellness.azurewebsites.net/LearnEarn/LearningInfoByModule/170",
						"https://meschinowellness.blob.core.windows.net/downloads/13U FHH Colon.pdf"));
		...
		EXPECTED_STRINGS.put("Healthy Aging Supplement Considerations and Early Detection_Strong",
				Arrays.asList("Because you are over 45 you should consider a supplement providing coenzyme Q10 and hawthorn for heart health.",
						"Because you are a woman over the age of 49 you may wish to consider taking a daily supplement to support your immune and detoxification systems",
						"Because you are a woman over 50 you may be interested to know that supplementation with a combination of Black cohosh,",
						"Because you are a woman over the age of 54 you may wish to consider taking a supplement to support brain and memory function.",
