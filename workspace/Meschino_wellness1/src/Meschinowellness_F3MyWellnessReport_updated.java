...
public class Meschinowellness_F3MyWellnessReport_updated {
	...
	public void login() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.id("UserName")).sendKeys("F3HRAtest@gmail.com");
		// Enter password
	...
	public static Map<String, List<String>> EXPECTED_STRINGS = new HashMap<String, List<String>>();
	{
		...
		EXPECTED_STRINGS.put("Dietary Assessment_Strong",
				Arrays.asList("Introduction to Your Dietary Assessment", "The Meschino Optimal Living Program",
						...
						"Based upon your responses", "52.00",
		...
		EXPECTED_STRINGS.put("Body Composition_Strong",
				Arrays.asList("Your Body Mass Index is: 14.35",
						"Your body mass index suggests that you may be underweight,",
						"Your present waist circumference is", "32."));
		...
		EXPECTED_STRINGS.put("Nutrient Deficiencies and Depletion of Nutrients_Strong", 
				...
				"Slow healing capability can be an indication", "Feeling chronically fatigued",
				...
				"Your regular use of antacid drugs is associated with depletion of the following nutrients", "Stress"));
		...
		EXPECTED_STRINGS.put("Family Health History_Strong",
				Arrays.asList("Family History of Breast and Colon Cancer",
						"You indicated that there is a family history of breast and colon cancer."));
