...
public class Meschinowellness_OldM2MyWellnessReport_updated {
    ...
    public static Map<String, List<String>> EXPECTED_STRINGS = new HashMap<String, List<String>>();
    {
        ...
        EXPECTED_STRINGS.put("Dietary Assessment_Strong",
                Arrays.asList("Introduction to Your Dietary Assessment",
                    ...
                    "You indicated that you consume high fat meat products only 2-3 times per month, and seldom, if ever consume high fat dairy products,",
        ...
        EXPECTED_STRINGS.put("Physical Activity_Strong",
                Arrays.asList("Endurance / Aerobic Activity",
                    ...
                    "You indicated that you regularly perform resistance or strength training a minimum of 4 times a wee",
