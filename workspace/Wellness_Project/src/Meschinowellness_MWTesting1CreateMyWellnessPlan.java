...
public class Meschinowellness_MWTesting1CreateMyWellnessPlan {
	String driverPath = "C:\\chromedriver_win32\\";//"C:\\geaco\\";
	private String UserName = "M1HRAtest@gmail.com"; //"mwtesting111@gmail.com";
	private String Password = "Test123@";//"Hello789@";
	private String Url = "http://demo-meschinowellness.azurewebsites.net/Account/Login";//"http://stage-meschinowellness.azurewebsites.net/Account/Login";//"http://demo-meschinowellness.azurewebsites.net/Account/Login"; 
	...
	public void login() throws Exception {
		...
		//public void MyWellnessPlan() throws Exception {
			...
			System.out.println("Following are the major health risk :");
			for (int i = 1, l = list.size(); i < l; i++) {
				System.out.println("("+ i +") " + list.get(i).getText().trim());
			}
			for (int i = 1, l = list.size(); i < l; i++) {
