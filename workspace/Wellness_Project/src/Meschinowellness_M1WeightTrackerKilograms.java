...
public class Meschinowellness_M1WeightTrackerKilograms {
...
public void login() throws Exception {
    ...
    //public void MyWellnessPlan() throws Exception {
            ...
            Thread.sleep(2000);
            weightValue = 54; // set 54 Kilograms to the 
            ((JavascriptExecutor)d).executeScript("arguments[0].setAttribute('value', '"+weightValue+"');", Weight); // 120 pounds
            Select dropdown1 = new Select(d.findElement(By.id("UOM_NUM")));
            dropdown1.selectByVisibleText("Kilograms");
            Thread.sleep(2000);
        ...
        public void GetRowData(WebElement CurrentRowElement) throws Exception
        {
            ...
            for(WebElement tdElement : td_collection)
            {
                ...
                {
                    System.out.println("Weight not matched after drop down change : " + weightValue);
                }
                col_num++;
            }
        }
