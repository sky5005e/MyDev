...
public class Meschinowellness_M4HRA {
	...
	public void login() throws Exception {
		...
		Thread.sleep(1000);
		d.findElement(By.id("UserName")).sendKeys("M4HRAtest@gmail.com");
		// Enter password
	...
	//public void MyHraTab() throws Exception {
		...
		dropdown1.selectByVisibleText("35");
		Thread.sleep(5000);
		...
		for(int i=1;i<leftLinks.size();i++)
		{
			...
			for(WebElement local_radio:radioquestion){ 
				...
				System.out.println("Before Displayed Q No ====>>>>" + value);
	...
	{		
		GetQuestionValue.put("Q1", 2);
		GetQuestionValue.put("Q2", 4);
		GetQuestionValue.put("Q3", 0);
		GetQuestionValue.put("Q4", 2);
		GetQuestionValue.put("Q5", 2);
		...
		GetQuestionValue.put("Q38", 1);
		GetQuestionValue.put("Q39", 0);
		GetQuestionValue.put("Q40", 0);
		GetQuestionValue.put("Q41",2);
		GetQuestionValue.put("Q42",1);
		GetQuestionValue.put("Q43",0);
		...
		GetQuestionValue.put("Q82",1);
		GetQuestionValue.put("Q83",2);
		GetQuestionValue.put("Q84",0);
		GetQuestionValue.put("Q85",1);
		...
		GetQuestionValue.put("Q178",0);
		GetQuestionValue.put("Q179",0);
		GetQuestionValue.put("Q180",0);
...
//		GetQuestionValue.put("Q212",2);
		...
		GetQuestionValue.put("Q222",0);
		GetQuestionValue.put("Q223",0);
		...
		GetQuestionValue.put("Q230",2);
		GetQuestionValue.put("Q231",1);
