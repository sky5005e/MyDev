...
public class Meschinowellness_M4MyWellnessReport_updated {
	...
	public void login() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.id("UserName")).sendKeys("M4HRAtest@gmail.com");
		// Enter password
	...
	public static Map<String, List<String>> EXPECTED_STRINGS = new HashMap<String, List<String>>();
	{
		...
		EXPECTED_STRINGS.put("Dietary Assessment_Strong",
				Arrays.asList("Introduction to Your Dietary Assessment", "The Meschino Optimal Living Program",
						...
						"Based upon your responses", "33.00",
					...
					//	"Your low intake of alcohol is most impressive from a health-risk standpoint.",
						...
						"You indicated that you consume high fat meat products 1-2 times per week and seldom, if ever, consume high fat dairy,",
//						"Your daily intake of high fat meat products and high fat dairy products",
						"You indicated that you use butter infrequently on bread, toast, other bread products, on baked potatoes/vegetables and/or when cookin"));
		...
		EXPECTED_STRINGS.put("Body Composition_Strong",
				Arrays.asList("Your Body Mass Index is: 27.12",
		...
		EXPECTED_STRINGS.put("Physical Activity_Strong",
				Arrays.asList("Endurance / Aerobic Activity",
						//"You indicated that you perform endurance/aerobic exercise for 120 minutes or less per week, on average.",
						"You indicated that you perform endurance/aerobic exercise for 120 to 150 minutes per week, on average.",
						//"Based upon your present age, your aerobic training zone is between 108 and 153 heart beats per minute",
						"Resistance / Strength Training",
						"You indicated that you regularly perform resistance or strength training 3 times a week",
						//"your protein requirement would be approximately 100 grams per day.",
						"100",
						"Flexibility / Stretching Exercise"));

		// Links Physical Activity
		EXPECTED_STRINGS.put("Physical Activity_Links",
				Arrays.asList("https://meschinowellness.blob.core.windows.net/downloads/protein_food_chart.pdf",
		...
		EXPECTED_STRINGS.put("Nutrient Deficiencies and Depletion of Nutrients_Strong", 
				Arrays.asList("Consuming more than 3 alcoholic beverages per week, on average, is associated with depletion of the following nutrients",
		...
		EXPECTED_STRINGS.put("Drug-Nutrient Interactions and Precautions_Strong", Arrays.asList("Drug-Nutrient Interactions and Precautions"
...
//				"If no warning appears then you may consider proceeding with the supplement considerations that appear in various sections of your feedback report. However, you should always consult a health care professional before making any change to your diet, exercise or supplementation program."
		...
		EXPECTED_STRINGS.put("Drug-Nutrient Interactions and Precautions_Italics", Arrays.asList(
		...
		EXPECTED_STRINGS.put("Family Health History_Links",
				Arrays.asList("https://meschinowellness.blob.core.windows.net/downloads/13U FHH Colon.pdf"));
		...
		EXPECTED_STRINGS.put("Healthy Aging Supplement Considerations and Early Detection_Strong",
				Arrays.asList("Healthy Aging Supplement Considerations and Early Detection Screening",
						"Because you are over 45 you should consider a supplement providing coenzyme Q10 and hawthorn for heart health.",
						"Because you are a man over 40 years of age you may wish to consider taking a daily supplement designed to support prostate health",
						...
						"PSA Blood Test: It is highly advisable to have your doctor check you PSA blood level on a yearly basis after age 50.",
						"Colonoscopy: It is advisable for men and women over the age of 50 to have a colonoscopy exam every year or two in order to screen for early stage colon cancer."));
