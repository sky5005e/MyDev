	...
	public static Map<String, List<String>> EXPECTED_STRINGS = new HashMap<String, List<String>>();
	{
		...
		EXPECTED_STRINGS.put("Dietary Assessment_Strong",
				Arrays.asList("Introduction to Your Dietary Assessment", 
						...
						"Your intake of fruit appears to be consistent with practices associated with a healthy diet",
						"Your low intake of alcohol is most impressive from a health-risk standpoint",
						"Your daily intake of high fat meat products and high fat dairy products are cause for serious concern.",
						"Your practice of using butter on bread, toast and other bread products, and on baked potatoes or included in the cooking of vegetables, eggs or sauces, etc. is a cause for concern"));
		...
		EXPECTED_STRINGS.put("Physical Activity_Strong",
				Arrays.asList("Endurance / Aerobic Activity",
						...
						"Based upon your present age, your aerobic training zone is between 113 and 160 heart beats per minute.",
						"You indicated that you regularly perform resistance or strength training once a week.",
						"your protein requirement would be approximately 75 grams per day.",
		...
		EXPECTED_STRINGS.put("Nutrient Deficiencies and Depletion of Nutrients_Strong", 
				Arrays.asList("Nutrient Deficiencies and Depletion of Nutrients",
						...
						"Irregular eating patterns often results in inadequate intake of many",
		...
		EXPECTED_STRINGS.put("Family Health History_Strong",
				Arrays.asList("You indicated that there is a family history of colon cancer."));

		// Links Family Health History
		EXPECTED_STRINGS.put("Family Health History_Links",
				Arrays.asList("https://meschinowellness.blob.core.windows.net/downloads/09M FHH Prostate-Colon.pdf"));
