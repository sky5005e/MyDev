...
public class Meschinowellness_M2HRA {
	...
	public void login() throws Exception {
		...
		if (d.findElement(By.id("btnRestart")).isDisplayed()) {
			System.out.println("btn restart displayed");
		...
		dropdown.selectByVisibleText("190");
		Thread.sleep(5000);
		...
		dropdown1.selectByVisibleText("34");
		Thread.sleep(5000);
		...
		for(int i=1;i<leftLinks.size();i++)
		{
			...
			for(WebElement local_radio:radioquestion){ 
                ...
                {
                	System.out.println("Question number====>>>>" + value +"-" + local_radio.getText()); 
			...
			Thread.sleep(3000);
			System.out.println("M2 HRA has been sucessfully completed");
	}
	...
	public void GetElement(WebElement element) {
		...
		public static Map<String, Integer> GetQuestionValue = new HashMap<String, Integer>();
		{
			...
			GetQuestionValue.put("Q41",4);
			GetQuestionValue.put("Q42",4);
			GetQuestionValue.put("Q43",1);
