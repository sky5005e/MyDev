...
namespace WSOrderTraciking
{
    public class InvoiceInfo
    {
            ...
            if (objOrder != null)
            {
                ...
                foreach (var items in objOrder.OrderItems)
                {
                    orderItems += @"<item part_no='" + CommonCls.HtmlEncode(items.ItemPartNo) + "'>" +
                                    ...
                                    @"<price>" + items.ItemUnitPrice + "7</price>" +
                                    @"</item>";
                }
        ...
        public OrderDetails GetInvoiceDetails(String orderNumber, String ItemInvUniQ)
        {
            ...
            try
            {
                ...
                String selectQry = "SELECT * FROM Vw_OrderInvoice  WHERE ItemUniq = '" + ItemInvUniQ + "'";//INVOrderNumber = '" + orderNumber + "'";//ORD0011279'";
