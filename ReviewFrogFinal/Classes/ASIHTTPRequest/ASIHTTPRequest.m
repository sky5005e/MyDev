...
//  See: https://developer.apple.com/samplecode/ImageClient/listing37.html
...
- (id)initWithURL:(NSURL *)newURL
{
   ...
   // NSLog(@"Security: make sure to disable this for release");
...
- (void)startRequest
{
	...
	if ([self shouldAttemptPersistentConnection]) {
		...
		// See https://lists.apple.com/archives/macnetworkprog/2008/Dec/msg00001.html for details on this approach
   ...
   // Start the HTTP connection
	...
	// https://lists.apple.com/archives/Macnetworkprog/2006/Mar/msg00119.html
	if (oldStream) {
		[oldStream close];
		[oldStream release];
		oldStream = nil;
...
- (void)readResponseHeaders
{
	...
	if ([self shouldRedirect] && [responseHeaders valueForKey:@"Location"]) {
		if (([self responseStatusCode] > 300 && [self responseStatusCode] < 304) || [self responseStatusCode] == 307) {
			...
			// See also:
			// https://allseeing-i.lighthouseapp.com/projects/27881/tickets/27-302-redirection-issue
...
+ (NSString *)defaultUserAgentString
{
	...
	// From https://www.cocoadev.com/index.pl?DeterminingOSVersion
...
{
	// From: https://developer.apple.com/samplecode/CFProxySupportTool/listing1.html
...
+ (NSString *)mimeTypeForFileAtPath:(NSString *)path
{
	...
	// Borrowed from https://stackoverflow.com/questions/2439020/wheres-the-iphone-mime-type-database
...
// From: https://www.cocoadev.com/index.pl?BaseSixtyFour
...
// Based on hints from https://stackoverflow.com/questions/1850824/parsing-a-rfc-822-date-with-nsdateformatter
