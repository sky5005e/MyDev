...
//  Part of ASIHTTPRequest -> https://allseeing-i.com/ASIHTTPRequest
//
...
{
	ASIFormDataRequest *currentForm = [[[self alloc] initWithURL:newURL] autorelease];
	//[currentForm setValidatesSecureCertificate:NO]; 
	//NSLog(@"BYPASSING SECURITY! -REMOVE BEFORE APP STORE!");
	return currentForm;
}
