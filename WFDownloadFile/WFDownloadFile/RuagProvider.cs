...
{
    public class RuagProvider
    {
        private HtmlDocument _htmlDoc = new HtmlDocument();
        private string _url = @"http://ruag.prospective.ch/index.cfm?sprCd=de";
        //http://www.ruag.com/de/Konzern/Karriere/offene_Stellen";// 
        ...
        public List<JobAdDto> GetJobAds()
        {
            ...
            {
                String url = String.Format("http://ruag.prospective.ch/index.cfm?sprCd=de&wlgo=1&wlsearch_SD_M1975_40=1&seq={0}", i);
        ...
        public int GetPageCount(String url)
        {
            ...
            int pgcount = Convert.ToInt32(Math.Ceiling(Convert.ToDecimal(Convert.ToDecimal(lastNum) / 5)));
            return pgcount;
        ...
        private void ParseHtml(string html, IList<JobAdDto> jobAds)
        {
            ...
            foreach (var item in parsedValue)
            {
                ...
                var linkNode = item.SelectSingleNode(".//td[@class='stellentitel']/a");
                ...
                var _regionNode = item.SelectSingleNode(".//td[@class='arbeitsort']");
