...
{
    public class HirslandenProvider
    {
        
        private HtmlDocument _htmlDoc = new HtmlDocument();
        private string _url = @"https://hirslanden.prospective.ch/index.cfm?sprCd=de";
        //http://www.hirslanden.ch/global/de/startseite/jobs_karriere/job_finder_freie_stellen.html";


        public string ProviderName
        {
            get { return "hirslanden"; }
        }
        ...
        public List<JobAdDto> GetJobAds()
        {
            ...
            {
                String url = String.Format(@"https://hirslanden.prospective.ch/index.cfm?sprCd=de&wlgo=1&seq={0}", i);
        ...
        private void ParseHtml(string html, IList<JobAdDto> jobAds)
        {
            ...
            foreach (var item in parsedValue)
            {
                ...
                var linkNode = item.SelectSingleNode(".//td[@class='itemlist_title']/a");
                ...
                var regNode = item.SelectSingleNode(".//td[@class='itemlist_klinik']");

                string _region = HtmlToPlainText(regNode.InnerText.Trim());
                Region = _region.Replace("\n","");
