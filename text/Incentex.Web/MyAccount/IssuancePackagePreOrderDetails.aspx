<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="IssuancePackagePreOrderDetails.aspx.cs" Inherits="MyAccount_IssuancePackagePreOrderDetails"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function CheckNum(id, value,IsComplete) {
            ...
            // for Partial and Complete not required
            if (parseInt(txt.value) > parseInt(value)) {
                if (parseInt(value) == 0) {
                    alert("You can not enter qty here.\n Since remaining qty is 0");
                }
                else {
                    alert("You can not enter qty more than left qty :" + value);
                }
                txt.value = "";
                txt.focus();
                return;
            }
            if (IsComplete == 'True' && parseInt(txt.value) < parseInt(value)) {
                alert("Please enter qty equal to issuance qty :" + value);
                txt.value = "";
                txt.focus();
                return;
            }
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
            ...
            <table width="100%">
                <tr>
                    <td width="20%" style="font-weight: bold; color: #878282; font-size: 13px;">
                        Eligable Date :
                        <asp:Label ID="lblEligible" runat="server" Style="color: Green; font-size: 13px;
                    ...
                    <td width="18%" style="font-weight: bold; color: #878282; font-size: 13px">
                        Expires Date :
                        <asp:Label ID="lblExpire" runat="server" Style="color: Red; font-size: 13px; font-weight: bold;"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <asp:Panel ID="pnlSingle" runat="server">
            <div id="Div1" class="tab_header" runat="server">
                <div id="Div2" class="tab_header_r" runat="server">
                    <table id="Table1" runat="server">
                        <tr>
                            ...
                            <td style="width: 9%; color: #878282;" runat="server" id="tdSinglePrice" visible="false">
                                Price
                            </td>
                            <td style="width: 14%; color: #878282;">
                                Quantity
                                    ...
                                    <div class="alignleft">
                                        <div class="agent_img">
                                            <p class="upload_photo gallery">
                                                ...
                                                <asp:HiddenField ID="hdnProductItemIDSingle" runat="server" />
                                                <asp:HiddenField ID="hdnSupplierIDSingle" runat="server" />
                                            ...
                                            <div class="cart_header alignleft">
                                                ...
                                                <div class="tailoring_detail_pad">
                                                    ...
                                                    <span style="color: #878282;">Length:
                                                        <asp:TextBox runat="server" Width="25px" ID="txtSingleTailoringlength"></asp:TextBox>
                                                    </span>
                                                    <br />
                                                    Run Charge :
                                            ...
                                            <td style="padding: 0px;">
                                                <div class="cart_header">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td style="width: 15%; color: #878282;">
                                                                <asp:Label ID="lblIssuance" runat="server" Text='<%# Eval("Issuance") %>'></asp:Label>
                                                            </td>
                                                            <td style="width: 9%; color: #878282;">
                                                            ...
                                                            <td style="width: 14%;">
                                                                <div class="qty_selbox" style="padding-top: 4px;">
                                                                    <asp:HiddenField ID="hdnUniformIssuancePolicyItemID" runat="server" Value='<%#Eval("UniformIssuancePolicyItemID") %>' />
                                                                    <asp:HiddenField ID="hdnMasterItemId" runat="server" Value='<%#Eval("MasterItemId") %>' />
                                                                    <asp:HiddenField ID="hdnRemainingValue" runat="server" />
                                                                    <asp:TextBox ID="txtQty" runat="server" MaxLength="5" Width="25px"></asp:TextBox>
                                                                </div>
                                                            </td>
                                                            <td style="width: 19%;">
        ...
        <div id="dvGroup" runat="server" class="headersmall_bg">
            <div class="headersmall_bgr title">
                <asp:Panel ID="pnlGroupHeader" runat="server">
                    <asp:Label ID="lblGroupItemAssociation" ForeColor="#878282" runat="server">Group Item Association</asp:Label>
                </asp:Panel>
        ...
        <asp:Panel ID="pnlGroup" runat="server">
            <asp:Repeater ID="rptGroupAssociation" runat="server" 
                OnItemDataBound="rptGroupAssociation_ItemDataBound">
                <ItemTemplate>
                 <asp:HiddenField ID="hdnGroupName" runat="server" Value='<%# Eval("NEWGROUP") %>' />
                        ...
                        <div id="Div4" class="tab_header_r" runat="server">
                            <table id="Table1" runat="server">
                                <tr>
                                    ...
                                    <td id="Td1" style="width: 9%; color: #878282;" runat="server">
                        ...
                        <div class="tab_header_r">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td style="width: 10%; color: #878282;">
                                        <asp:Label ID="lblIssuanceGroup" Text='<%# Eval("Issuance") %>' runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 9%; color: #878282;">
                                        <asp:Label ID="lblPurchaseGroup" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 14%; color: #878282;">
                                        <asp:Label ID="lblBalanceGroup" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 9%; color: #878282;">
                                    </td>
                                    <td style="width: 14%; color: #878282;">
                                        ...
                                        <tr>
                                            <td style="width: 24%; color: #878282;">
                                                <asp:HiddenField ID="hdnChildGroupMasterItemId" Value='<%#Eval("MasterItemId")%>'
                                                    runat="server" />
                                                <asp:Label ID="lblItemNumberGroup" runat="server"></asp:Label>
                                                &nbsp;&nbsp;
                                                <div class="alignleft">
                                                    <div class="agent_img">
                                                        <p class="upload_photo gallery">
                                                            ...
                                                            <asp:HiddenField ID="hdnWeathertype" Value='<%# Eval("WeatherTypeid") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnStoreProductid" Value='<%# Eval("StoreProductid") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnProductItemIDGroup" runat="server" />
                                                            <asp:HiddenField ID="hdnSupplierIDGroup" runat="server" />
                                                ...
                                                <div class="aligncenter">
                                                    <div class="leftalign" style="padding-left: 20px;">
                                                        <asp:HyperLink ID="lnkSizingChartGroup" Target="_blank" CssClass="btn_pdf2" Visible="true"
                                                            runat="server"><span>Sizing Chart</span></asp:HyperLink>
                                                    </div>
                                                </div>
                                                <div class="alignnone spacer20">
                                                    ...
                                                    <asp:Panel ID="pnlTailoringGroup" runat="server">
                                                        <div class="cart_header alignleft">
                                                            ...
                                                            <div class="tailoring_detail_pad">
                                                                ...
                                                                <br />
                                                                <span style="color: #878282;">Length:
                                                                    <asp:TextBox runat="server" Width="25px" ID="txtTailoringlengthGroup"></asp:TextBox>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </asp:Panel>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 9%; color: #878282;">
                                                                            ...
                                                                            <asp:HiddenField ID="hdnItemNumberGroup" runat="server" />
                                                                        </td>
                                                                        <td style="width: 13%;">
                                                                            <div class="qty_selbox" style="padding-top: 4px;">
                                                                                <asp:HiddenField ID="hdnUniformIssuancePolicyItemIDGroup" runat="server" Value='<%#Eval("UniformIssuancePolicyItemID") %>' />
                                                                                <asp:HiddenField ID="hdnMasterItemIdGroup" runat="server" Value='<%#Eval("MasterItemId") %>' />
                                                                                <asp:HiddenField ID="hdnRemainingValueGroup" runat="server" />
                                                                                <asp:TextBox ID="txtQtyGroup" MaxLength="5" runat="server"
                                                                        ...
                                                                        <td style="width: 20%;">
                                                                            ...
                                                                            <div class="form_box">
                                                                                <span class="custom-sel custom_sel_size" style="width: 100%;">
                                                                                    <asp:DropDownList ID="ddlSizeGroup" runat="server" OnSelectedIndexChanged="ddlSizeGroup_SelectedIndexChanged"
        ...
        <div id="dvGroupBudget" runat="server" class="headersmall_bg">
            <div class="headersmall_bgr title">
                <asp:Panel ID="pnlGroupBudgetHeader" runat="server">
                    <asp:Label ID="lblGroupItemAssociationBudget" ForeColor="#878282" runat="server">Budget Item Association</asp:Label>
                </asp:Panel>
        ...
        <asp:Panel ID="pnlGroupBudget" runat="server">
            <asp:Repeater ID="rptGroupBudgetAssociation" runat="server" OnItemDataBound="rptGroupBudgetAssociation_ItemDataBound">
                <ItemTemplate>
                 <asp:HiddenField ID="hdnGroupBName" runat="server" Value='<%# Eval("NEWGROUP") %>' />
                        ...
                        <div id="Div6" class="tab_header_r" runat="server">
                            <table id="Table2" runat="server">
                                <tr>
                                    ...
                                    <td id="Td2" style="width: 2%; color: #878282;" runat="server">
                                        <asp:Label ID="tdIssuance" Text="Issuance" runat="server" Visible="false"></asp:Label>
                                    </td>
                                    <td id="Td3" style="width: 2%; color: #878282;" runat="server">
                                        <asp:Label ID="Td1" Text="Purchased" runat="server" Visible="false"></asp:Label>
                                    </td>
                                    <td id="Td4" style="width: 2%; color: #878282;" runat="server">
                                        <asp:Label ID="Label1" Text="Balance Left" runat="server" Visible="false"></asp:Label>
                                    </td>
                                    <td style="width: 11%; color: #878282;">
                                        Budget Amt
                                    </td>
                                    <td id="Td5" style="width: 11%; color: #878282;">
                                        Budget Used
                                    </td>
                                    <td style="width: 11%; color: #878282;">
                                        Budget Left
                        ...
                        <div class="tab_header_r">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td id="Td6" style="width: 2%; color: #878282;" runat="server" visible="false">
                                        ...
                                        <tr>
                                            <td style="width: 22%; color: #878282;">
                                                <asp:HiddenField ID="hdnChildGroupBudgetAssociationMasterItemId" Value='<%#Eval("MasterItemId")%>'
                                                    runat="server" />
                                                <asp:Label ID="lblItemNumberGrpB" runat="server"></asp:Label>
                                                &nbsp;
                                                <div class="alignleft">
                                                    <div class="agent_img">
                                                        <p class="upload_photo gallery">
                                                            ...
                                                            <asp:HiddenField ID="hdnWeathertype" Value='<%# Eval("WeatherTypeid") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnStoreProductid" Value='<%# Eval("StoreProductid") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnProductItemIDGrpBudget" runat="server" />
                                                            <asp:HiddenField ID="hdnSupplierIDGrpBudget" runat="server" />
                                                            <a id="prettyphotoDiv" href="~/UploadedImages/employeePhoto/employee-photo.gif" rel='prettyPhoto'
                                                                runat="server">
                                                                <img id="imgSplashImage" src="~/UploadedImages/employeePhoto/employee-photo.gif"
                                                                    height="198" width="145" runat="server" alt='Loading' />
                                                ...
                                                <div class="aligncenter">
                                                    <div class="leftalign" style="padding-left: 20px;">
                                                        <asp:HyperLink ID="lnkGroupBudgetSizingChart" Target="_blank" CssClass="btn_pdf2"
                                                            Visible="true" runat="server"><span>Sizing Chart</span></asp:HyperLink>
                                                    </div>
                                                </div>
                                                <div class="alignnone spacer20">
                                                </div>
                                                    ...
                                                    <asp:Panel ID="pnlTailoringGroupBudget" runat="server">
                                                        <div class="cart_header alignleft">
                                                            ...
                                                            <div class="tailoring_detail_pad">
                                                                ...
                                                                <br />
                                                                <span style="color: #878282;">Length:
                                                                    <asp:TextBox runat="server" Width="25px" ID="txtBudgetTailoringlength"></asp:TextBox>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </asp:Panel>
                                                            ...
                                                            <div class="cart_header">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0">
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 10%;">
                                                                            <div class="qty_selbox" style="padding-top: 4px;">
                                                                                <asp:HiddenField ID="hdnUniformIssuancePolicyItemIDGrpB" runat="server" Value='<%#Eval("UniformIssuancePolicyItemID") %>' />
                                                                                <asp:HiddenField ID="hdnMasterItemIdGrpB" runat="server" Value='<%#Eval("MasterItemId") %>' />
                                                                                <asp:HiddenField ID="hdnRemainingValueGrpB" runat="server" />
                                                                                <asp:TextBox ID="txtQtyGrpB" MaxLength="5" runat="server"
                                                                                    Width="25px"></asp:TextBox>
                                                                            </div>
                                                                        </td>
                                                                        <td style="width: 19%;">
                                                                            ...
                                                                            <div class="form_box">
                                                                                <span class="custom-sel custom_sel_size" style="width: 100%;">
                                                                                    <asp:DropDownList ID="ddlSizeGrpB" OnSelectedIndexChanged="ddlSizeGrpB_SelectedIndexChanged"
        ...
        <div id="dvShipandCheckout" runat="server">
            <table class="form_table">
                <tr id="Tr1" style="width: 40%;" runat="server" visible="false">
                    <td class="formtd">
