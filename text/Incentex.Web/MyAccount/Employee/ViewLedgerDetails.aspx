                    ...
                    <asp:GridView ID="gvEmployeeTransactionHistory" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Check">
                                ...
                                <ItemTemplate>
                                    <asp:Label CssClass="first" runat="server" ID="lblTransactionType" Text='<% # (Convert.ToString(Eval("TransactionType")).Length > 20) ? Eval("TransactionType").ToString().Substring(0,20)+"..." : Convert.ToString(Eval("TransactionType"))  %>'
                                        ToolTip='<% #Eval("TransactionType")  %>' />
                                    <div class="corner">
            ...
            <div class="pp_content_container" style="">
                <div class="pp_left" style="">
                    <div class="pp_right" style="">
                        <div class="pp_content" style="height: 278px; display: block;">
