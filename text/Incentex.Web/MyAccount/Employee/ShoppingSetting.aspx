                        ...
                        <tr>
                            <td>
                                <asp:DataList ID="dtPaymentOptions" runat="server">
                                    <ItemTemplate>
                                        <span class="custom-checkbox alignleft" style="float: left;" id="paymentspan" runat="server">
                                            <asp:CheckBox ID="chkPaymentOptions" runat="server" onclick='<%# string.Format("TogleMOASPanel(\"{0}\")",Eval("sLookupName")) %>' />
                                        </span>
                                        <label>
