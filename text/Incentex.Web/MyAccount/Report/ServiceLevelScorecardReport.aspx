<%@ Page Title="Service Level Scorecard Dashboard" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="ServiceLevelScorecardReport.aspx.cs" Inherits="MyAccount_Report_ServiceLevelScorecardReport" %>
        ...
        <div id="dvHelpTicketsbyWorkgroup" runat="server" visible="false">
            ...
            <div class="black_middle" style="text-align: center;">
                <asp:Chart ID="chrtHelpTicketsbyWorkgroup" runat="server" BackColor="Transparent" OnClick="chrtHelptickets_Click"
                    Height="600" Width="900">
                    <Series>
                        <asp:Series Name="Series1" ChartType="Bar" IsValueShownAsLabel="true" PostBackValue="#VALX" XValueMember="Workgroup"
                            YValueMembers="TicketCount" LabelForeColor="#878282" ToolTip="#VALX : #VALY"
