<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="BrowserWiseUser.aspx.cs" Inherits="TrackingCenter_BrowserWiseUser"
    Title="Browser wise user" %>
                ...
                <div>
                    ...
                    <div id="dvgrid" align="center">
                        <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="ord_header"
                            CssClass="orderreturn_box" GridLines="None" RowStyle-CssClass="ord_content" Width="50%">
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <span class="centeralign">User Name</span>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblUserName" Text='<% #(Convert.ToString(Eval("Name")))%>'
