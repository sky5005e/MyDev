...
public partial class TrackingCenter_BrowserWiseUser : PageBase
{
    #region Data Members
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                ((Label)Master.FindControl("lblPageHeading")).Text = "Browser wise User Report";
                ((HyperLink)Master.FindControl("lnkLoginUrl")).Text = "<span><< Go Back</span>";
                ((HyperLink)Master.FindControl("lnkLoginUrl")).NavigateUrl = "~/TrackingCenter/BrowserType.aspx?BrowserName=" + BrowserName + "&sdate=" + sdate + "&edate=" + edate;                
    ...
    public void BindGird()
    {
        ...
        {
            BrowserName = Convert.ToString(Request.QueryString.Get("BrowserName"));
        ...
        {
            Response.Redirect("~/TrackingCenter/BrowserType.aspx");
        }
        List<GetBrowserWiseUserNameResult> objList = ObjRepo.GetUserBrowserWise(BrowserName, Convert.ToDateTime(sdate), Convert.ToDateTime(edate));
