...
public partial class controller_ReplyToPurchaseOrder : System.Web.UI.Page
{
    #region Properties
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            //    client.Login(CommonMails.ReplyToOrderSummary, CommonMails.ReplyToOrderSummaryPassword);
            ...
            //        {
            //            List<Message> lstPOP = FetchAllMessages(CommonMails.POPHost, CommonMails.POPPort, CommonMails.SSL, CommonMails.ReplyToOrderSummary, CommonMails.ReplyToOrderSummaryPassword);
            ...
            //                    //QueryString flow = on__un__ad__cb__nt__ni__en
            //                    if (ReplyTo.Contains("+on") && ReplyTo.Contains("un") && ReplyTo.Contains("en") && ReplyTo.Contains("nt") && ReplyTo.Contains("cb") && ReplyTo.Contains("ad") && ReplyTo.Contains("ni"))
            //                    {
            ...
            //                                try
            //                                {
            //                                    Int64 OrderID = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("+on") + 3, ReplyTo.LastIndexOf("un") - ReplyTo.LastIndexOf("+on") - 3));
            ...
            //                                    if (objOrder != null)
            //                                    {
            //                                        String sUserInfoID = ReplyTo.Substring(ReplyTo.LastIndexOf("un") + 2, ReplyTo.LastIndexOf("ad") - ReplyTo.LastIndexOf("un") - 2);

            //                                        Int64 CreatedUserInfoId = 0;
            //                                        Int64 AdminUserInfoId = 0;
            //                                        Int64 NoteID = 0;
            //                                        Int32 NoteType = 0;
            //                                        Int64? UserInfoID = null;

            //                                        AdminUserInfoId = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("ad") + 2, ReplyTo.LastIndexOf("cb") - ReplyTo.LastIndexOf("ad") - 2));
            //                                        CreatedUserInfoId = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("cb") + 2, ReplyTo.LastIndexOf("nt") - ReplyTo.LastIndexOf("cb") - 2));
            //                                        NoteType = Convert.ToInt32(ReplyTo.Substring(ReplyTo.LastIndexOf("nt") + 2, ReplyTo.LastIndexOf("ni") - ReplyTo.LastIndexOf("nt") - 2));
            //                                        NoteID = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("ni") + 2, ReplyTo.LastIndexOf("en@") - ReplyTo.LastIndexOf("ni") - 2));
            ...
            //                                        else if (NoteType == 3)
            //                                            strNoteFor = Incentex.DAL.Common.DAEnums.GetNoteForTypeName(Incentex.DAL.Common.DAEnums.NoteForType.CustomerOrder);
            //                                        //else if (NoteType == 4)
            //                                        //    strNoteFor = Incentex.DAL.Common.DAEnums.GetNoteForTypeName(Incentex.DAL.Common.DAEnums.NoteForType.BackOrderedUntil);
            ...
            //                                        if (NoteType == 1)
            //                                        {
            //                                            SupplierID = objSupplierRepository.GetByUserInfoId(Convert.ToInt64(UserInfoID)).SupplierID;
            //                                            objNoteDetail.ForeignKey = SupplierID;
            //                                            objNoteDetail.SpecificNoteFor = Convert.ToString(OrderID);
            //                                        }
            //                                        else if (NoteType == 2)
            //                                        {
            ...
            //                                        {
            //                                            objNoteDetail.ForeignKey = OrderID;
            //                                            objNoteDetail.SpecificNoteFor = Convert.ToString(UserInfoID);
            //                                            if (AdminUserInfoId != 0)
            //                                            {
            //                                                objNoteDetail.ReceivedBy = Convert.ToString(AdminUserInfoId);
            //                                            }
            //                                        }
            ...
            //                                        if (NoteType == 1)
            //                                            TrailingNotesContent = OrderRepos.TrailingNotes(Convert.ToInt64(SupplierID), strNoteFor, Convert.ToString(OrderID), "<br/>");
            //                                        else if (NoteType == 2)
            //                                            TrailingNotesContent = OrderRepos.TrailingNotes(OrderID, strNoteFor, "IEInternalNotes", "<br/>");
            //                                        else
            //                                            TrailingNotesContent = OrderRepos.TrailingNotes(OrderID, strNoteFor, Convert.ToString(UserInfoID), "<br/>");
            //                                        #endregion


            //                                        //Send email to all the IE when reply from email as per Ken instruction
            //                                        List<OrderNoteReceipientDetail> objIEList = new OrderNoteRecipientDetailRepository().GetIEListByOrderID(OrderID, NoteID);
            //                                        for (int i = 0; i < objIEList.Count; i++)
            //                                            SendNotes(OrderID, Convert.ToInt64(objIEList[i].UserInfoId), NoteType, TrailingNotesContent, Convert.ToInt64(CreatedUserInfoId));

            //                                        SendEMailRepliesForNotes(OrderID, TrailingNotesContent, NoteType, Convert.ToString(objMsg.Subject), AdminUserInfoId, CreatedUserInfoId, SupplierID, Convert.ToInt64(UserInfoID));
        ...
        {
            if (!Convert.ToBoolean(Application["ReplyToLiveInvalidDateOrderView"]))
            {
                if (ex.Message.StartsWith("Invalid Date: Invalid time zone. Input: \""))
                {
                    Application["ReplyToLiveInvalidDateOrderView"] = true;
    ...
    private void GetIMAPEmails()
    {
        ...
        using (Imap imap = new Imap())
        {
            ...
            imap.Login(CommonMails.ReplayTopurchaseordermanagement, CommonMails.ReplayTopurchaseordermanagementPassword);                       // You can also use: LoginPLAIN, LoginCRAM, LoginDIGEST, LoginOAUTH methods,            
    ...
    private void ProcessMessage(MailBee.Mime.MailMessage email)
    {
        ...
        try
        {
            ...
            if (ReplyTo.Contains("+on") && ReplyTo.Contains("un") && ReplyTo.Contains("en") && ReplyTo.Contains("nt") && ReplyTo.Contains("rb") && ReplyTo.Contains("ni") && ReplyTo.Contains("rtp"))
            {

                Int64 OrderID = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("+on") + 3, ReplyTo.LastIndexOf("un") - ReplyTo.LastIndexOf("+on") - 3));

                PurchaseOrderManagmentRepository OrderRepos = new PurchaseOrderManagmentRepository();

                PurchaseOrderMaster objOrder = OrderRepos.GetPurchaseOrderByID(OrderID);
                ...
                if (objOrder != null)
                {
                    ...
                    Int64 ReplayUserId = 0;
                    Int64 NoteID = 0;
                    Int32 NoteType = 0;
                    Int64? UserInfoID = null;
                    Int64 ReceipientType = 0;

                    //AdminUserInfoId = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("ad") + 2, ReplyTo.LastIndexOf("rb") - ReplyTo.LastIndexOf("ad") - 2));
                    ReplayUserId = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("rb") + 2, ReplyTo.LastIndexOf("nt") - ReplyTo.LastIndexOf("rb") - 2));
                    NoteType = Convert.ToInt32(ReplyTo.Substring(ReplyTo.LastIndexOf("nt") + 2, ReplyTo.LastIndexOf("ni") - ReplyTo.LastIndexOf("nt") - 2));
                    NoteID = Convert.ToInt64(ReplyTo.Substring(ReplyTo.LastIndexOf("ni") + 2, ReplyTo.LastIndexOf("rtp") - ReplyTo.LastIndexOf("ni") - 2));
                    ReceipientType = Convert.ToInt16(ReplyTo.Substring(ReplyTo.LastIndexOf("rtp") + 3, ReplyTo.LastIndexOf("en@") - ReplyTo.LastIndexOf("rtp") - 3));
                    ...
                    String strNoteFor = String.Empty;
                    if (NoteType == 1)
                        strNoteFor = Incentex.DAL.Common.DAEnums.GetNoteForTypeName(Incentex.DAL.Common.DAEnums.NoteForType.SupplierPurchaseOrder);
                    else if (NoteType == 2)
                        strNoteFor = Incentex.DAL.Common.DAEnums.GetNoteForTypeName(Incentex.DAL.Common.DAEnums.NoteForType.PurchaseOrderDetailsIEs);
                    ...
                    if (NoteType == 1)
                    {
                        if (ReceipientType == (long)Incentex.DAL.Common.DAEnums.UserTypes.Supplier)
                        {
                            SupplierID = objSupplierRepository.GetByUserInfoId(Convert.ToInt64(UserInfoID)).SupplierID;
                            objNoteDetail.ForeignKey = SupplierID;
                        }
                        ...
                        {
                            objNoteDetail.ForeignKey = UserInfoID;
                        }
                        objNoteDetail.SpecificNoteFor = Convert.ToString(OrderID);
                    }
                    else if (NoteType == 2)
                    ...
                    if (NoteType == 1)
                        TrailingNotesContent = OrderRepos.TrailingNotes(SupplierID, strNoteFor, Convert.ToString(OrderID), "<br/>");
                    else if (NoteType == 2)
                        TrailingNotesContent = OrderRepos.TrailingNotes(OrderID,strNoteFor, "POIEInternalNotes", "<br/>");
                    #endregion
                    ...
                    for (int i = 0; i < objIEList.Count; i++)
                    {
                        SendNotes(OrderID, Convert.ToInt64(objIEList[i].UserInfoId), NoteType, TrailingNotesContent, objNoteDetail.CreatedBy.Value, NoteID);
                    }

                    SendEMailRepliesForNotes(OrderID, objOrder.PurchaseOrderNumber, TrailingNotesContent, NoteType, Convert.ToString(email.Subject), ReplayUserId, SupplierID, Convert.ToInt64(UserInfoID), NoteID);
                }
            }
        }
        catch (Exception ex)
    ...
    private void SendEMailRepliesForNotes(Int64 OrderID, String PurchaseOrderNumber, String Reply, Int32 NoteType, String sSubject, Int64 ReplayUserId, Int64 SupplierID, Int64 UserInfoID, Int64 NoteID)
    {
        try
        {
            ...
            {
                lstRecipients = OrderRepos.GetRecipentsFromOrderID(0, 0, ReplayUserId, SupplierID);
            }

            foreach (SelectRecipentsForReplyTo recipient in lstRecipients)
            {
                //Email Management
                if (objManageEmailRepo.CheckEmailAuthentication(Convert.ToInt64(recipient.UserInfoID), Convert.ToInt64(Incentex.DAL.Common.DAEnums.ManageEmail.OrderNotes)) == true)
                {
                    ...
                    //MessageBody.Replace("{OrderNo}", PurchaseOrderNumber);
                    ...
                    String ReplyToAddress = sReplyToadd.Substring(0, sReplyToadd.IndexOf('@')) + "+on" + OrderID + "un" + sUserInfoID + "ad0" + "rb" + UserInfoID + "nt" + NoteType + "ni" + NoteID + "rtp" + recipient.Usertype + "en" + sReplyToadd.Substring(sReplyToadd.IndexOf('@'), sReplyToadd.Length - sReplyToadd.IndexOf('@'));
                    new CommonMails().SendMailWithReplyTo(Convert.ToInt64(sUserInfoID), "Purchase Order Notes", Common.EmailFrom, Convert.ToString(recipient.Email), sSubject, MessageBody.ToString(), Common.DisplyName, ReplyToAddress, Common.UserName, Common.Password, Common.SMTPHost, Common.SMTPPort.ToString(), "Normal", Common.SSL, true);
                }
            }
        }
        catch (Exception ex)
    ...
    #region Send Notes to all the IE when reply from email as per Ken instruction
    private void SendNotes(Int64 OrderID, Int64 ToUserInfoID, Int64 NoteType, String Message, Int64 CreatedUserID, Int64 NoteID)
    {
        try
        {
            PurchaseOrderMaster objOrder = new PurchaseOrderManagmentRepository().GetPurchaseOrderByID(OrderID);
            ...
            if (dsEmailTemplate != null)
            {
                ...
                String sSubject = "Incentex Message - Purchase Order Number " + objOrder.PurchaseOrderNumber;
                ...
                //messagebody.Replace("{OrderNo}", objOrder.PurchaseOrderNumber);
                ...
                if (new ManageEmailRepository().CheckEmailAuthentication(objUserInformation.UserInfoID, Convert.ToInt64(Incentex.DAL.Common.DAEnums.ManageEmail.OrderNotes)) == true)
                {
                    ...
                    //QueryString flow = on__un__ad__rb__nt__ni__rtp__en
                    //on: order number
                    //un: user number(userid)
                    //ad: admin id(if applicable else 0)
                    //rb: Recevied by id 
                    ...
                    String sReplyToadd = CommonMails.ReplayTopurchaseordermanagement;//"ordernotes@world-link.us.com";
                    String ReplyToAddress = sReplyToadd.Substring(0, sReplyToadd.IndexOf('@')) + "+on" + objOrder.PurchaseOrderID + "un" + objUserInformation.UserInfoID + "ad0rb" + CreatedUserID + "nt" + NoteType + "ni" + NoteID + "rtp" + Convert.ToInt64(Incentex.DAL.Common.DAEnums.UserTypes.IncentexAdmin) + "en" + sReplyToadd.Substring(sReplyToadd.IndexOf('@'), sReplyToadd.Length - sReplyToadd.IndexOf('@'));
