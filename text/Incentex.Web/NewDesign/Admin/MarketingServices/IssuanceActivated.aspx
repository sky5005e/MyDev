<%@ Page Language="C#" MasterPageFile="~/NewDesign/FrontMasterPage.master" AutoEventWireup="true"
    CodeFile="IssuanceActivated.aspx.cs" Inherits="Admin_IssuanceActivated" Title="incentex | Issuance Activated" %>
            ...
            <section id="container" class="cf GSE-page">
                <div class="narrowcolumn alignleft">                    
                    <div class="filter-block cf">
                        <div class="title-txt">
                            <span>Search</span><a href="#" title="Help video" onclick="GetHelpVideo('Marketing Services','Issuance Activated')">Help video</a></div>
                ...
                <div class="widecolumn alignright">
                    <div class="filter-content" id="GseManagement">
                        <div class="filter-headbar cf">
                            <span class="headbar-title">Issuance Activated</span> <em id="totalcount_em" runat="server" visible="false"></em>
                        ...
                        <div class="gse-tablebox cf">
                            <asp:GridView ID="gvIssuanceActivated" runat="server" AutoGenerateColumns="false" GridLines="None" OnRowCommand="gvIssuanceActivated_RowCommand" CssClass="table-grid">
                                <Columns>
                                    <asp:TemplateField SortExpression="EligibleDate">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkbtnActivatoinDate" runat="server" CommandArgument="EligibleDate" CommandName="Sort"><span style="text-align:center" >Activation Date</span></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>                      
                                            <asp:Label ID="lblActivationDate" runat="server" Text='<%# Eval("EligibleDate", "{0:MM/dd/yyyy}") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField SortExpression="IssuanceProgramName">
                                        ...
                                        <ItemTemplate>                                            
                                            ...
                                            <asp:LinkButton ID="lnkIssuanceName" runat="server" CommandArgument='<%# Eval("UniformIssuancePolicyID") %>' CommandName="IssuanceProgramName" Text='<%# Eval("IssuanceProgramName") %>'></asp:LinkButton>
                                        </ItemTemplate>
                                ...
                                <EmptyDataTemplate>
                                    <table class="table-grid">
        	                            <tr>
          	                                <th class="col1">Activation Date</th>
