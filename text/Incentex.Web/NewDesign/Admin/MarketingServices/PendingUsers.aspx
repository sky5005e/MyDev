<%@ Page Language="C#" MasterPageFile="~/NewDesign/FrontMasterPage.master" AutoEventWireup="true"
    CodeFile="PendingUsers.aspx.cs" Inherits="Admin_PendingUsers" Title="incentex | Pending Users" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#<%= btnSearchPendingUsers.ClientID %>, #<%= btnSend.ClientID %>").click(function() {
                $(".progress-layer").show();
            });
        });

        function CheckAllCheckbox(Checkbox) {
            var GridVwHeaderChckbox = document.getElementById("<%=gvPendingUsers.ClientID %>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UPGeneral" runat="server">
        <Triggers>
            <asp:PostBackTrigger ControlID="btnSearchPendingUsers" />
        </Triggers>
        <ContentTemplate>
            <section id="container" class="cf GSE-page">
                <div class="narrowcolumn alignleft">                    
                    <div class="filter-block cf">
                        <div class="title-txt">
                            <span>Search</span><a href="#" title="Help video" onclick="GetHelpVideo('Marketing Services','Pending Users')">Help video</a></div>
                        ...
                        <ul class="cf">
                            ...
                            <li>
                                <asp:TextBox ID="txtNameOfPendingUser" runat="server" CssClass="input-field-all" placeholder="Name of Pending User"
                                    ToolTip="Name of Pending User" tabindex="1"></asp:TextBox>
                            </li>                            
                            <li>
                                <asp:TextBox ID="txtNameOfApprover" runat="server" CssClass="input-field-all" placeholder="Name of Approver"
                                    ToolTip="Name of Approver" tabindex="1"></asp:TextBox>
                            </li>
                            <li>
                                <button id="btnSearchPendingUsers" runat="server" class="blue-btn" onserverclick="btnSearchPendingUsers_Click">Search</button>
                            </li>
                        </ul>
                        </div>
                    </div>
                ...
                <div class="widecolumn alignright">
                    <div class="filter-content" id="GseManagement">
                        <div class="filter-headbar cf">
                            <span class="headbar-title">Pending Users</span> <em id="totalcount_em" runat="server" visible="false"></em>
                        ...
                        <div class="gse-tablebox cf">
                            <asp:GridView ID="gvPendingUsers" runat="server" AutoGenerateColumns="false" GridLines="None" OnRowCommand="gvPendingUsers_RowCommand" OnRowDataBound="gvPendingUsers_RowDataBound" CssClass="table-grid">
                                <Columns>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdbApproverEmailID" runat="server" Value='<%# Eval("ApproverEmailID") %>' />
                                    ...
                                    <asp:TemplateField SortExpression="NameOfPendingUser">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkbtnNameOfPendingUser" runat="server" CommandArgument="NameOfPendingUser" CommandName="Sort"><span >Name of Pending Users</span></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblNameOfPendingUser" Text='<%# Eval("NameOfPendingUser") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="col4" />
                                        <ItemStyle CssClass="col4" />
                                    </asp:TemplateField>
                                    <asp:TemplateField SortExpression="NameOfApprover">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnkbtnNameOfApprover" runat="server" CommandArgument="NameOfApprover" CommandName="Sort"><span >Name of Approver</span></asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>                                            
                                            <asp:Label runat="server" ID="lblNameOfApprover" Text='<%# Eval("NameOfApprover") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle CssClass="col4" />
                                        <ItemStyle CssClass="col4" />
                                    </asp:TemplateField>
                                ...
                                <EmptyDataTemplate>
                                    <table class="table-grid">
                                        ...
                                        <th class="col4">Name of Pending User</th>
