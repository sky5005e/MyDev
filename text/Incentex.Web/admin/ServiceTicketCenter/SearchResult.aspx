<%@ Page Title="Support Tickets" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="SearchResult.aspx.cs" Inherits="admin_ServiceTicketCenter_SearchResult"
...
//        }
        ...
        function CollapsibleContainerTitleOnClick() {            
            ...
            //if ($("#ctl00_ContentPlaceHolder1_chkExpandOneAtATime").attr("checked") == true) {                
                //$(".collapsibleContainerContent").each(function() {
                    //var hdnOther = document.getElementById($(this).parent().attr("id").substring(0, $(this).parent().attr("id").length - 13) + "hdnIamExpanded");
                    //hdnOther.value = "false";
                    //if (hdnOther.id != hdnIamExpanded.id)
                        //$(this).hide();
                //});
            //}
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            //$("#ctl00_ContentPlaceHolder1_chkExpandCollapseAll").click(function() {
                //if ($("#ctl00_ContentPlaceHolder1_chkExpandCollapseAll").attr("checked") == false) {                
                    //$(".collapsibleContainerContent").each(function() {
                        //var hdnIamExpanded = document.getElementById($(this).parent().attr("id").substring(0, $(this).parent().attr("id").length - 13) + "hdnIamExpanded");
                        //hdnIamExpanded.value = "false";
                        //$(this).hide();                
                    //});
                //}
                //else if ($("#ctl00_ContentPlaceHolder1_chkExpandCollapseAll").attr("checked") == true) {                
                    //$(".collapsibleContainerContent").each(function() {
                        //var hdnIamExpanded = document.getElementById($(this).parent().attr("id").substring(0, $(this).parent().attr("id").length - 13) + "hdnIamExpanded");
                        //hdnIamExpanded.value = "true";
                        //$(this).show();                
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DueDatePopup(id, duedate, messageToShowIn) {            
            $("#DueDatePopupTitle").html('Ticket no.: ' + id + '.');
            $("#ctl00_ContentPlaceHolder1_hdnPopupTicketID").val(id);
            $("#ctl00_ContentPlaceHolder1_txtDueDate").val(duedate);
            $("#ctl00_ContentPlaceHolder1_hdnPopupMsgToShowIn").val(messageToShowIn);
            $("#ctl00_ContentPlaceHolder1_pnlDueDate").show();
        }
        
        function CloseTicket(id, messageToShowIn) {
        ...
        function FlagTicket(ticketid, messageToShowIn) {
                        ...
                        <asp:GridView ID="gvServiceTickets" runat="server" HeaderStyle-CssClass="ord_header"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Check">
                                    <HeaderTemplate>
                                        <span class="custom-checkbox gridheader chkClass123xyz">
                                    ...
                                    <ItemTemplate>
                                        <span class="first custom-checkbox gridcontent centeralign chkClass123xyz">
                                        ...
                                        <div class="pp_inline clearfix">
                                            <div class="form_popup_box" style="padding-top: 15px;">
                                                <div class="label_bar">
                                                    ...
                                                    <asp:HiddenField ID="hdnPopupMsgToShowIn" runat="server" />
