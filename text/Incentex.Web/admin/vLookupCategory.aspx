<%@ Page Title="World-Link System - Category Listing" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="vLookupCategory.aspx.cs" Inherits="admin_vLookupCategory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    ...
                    messages: {
                        ctl00$ContentPlaceHolder1$txtCategoryName: {
                            required: replaceMessageString(objValMsg, "Required", "category name")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <br />
            <br />
            <asp:DataList ID="dtlCategory" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                OnItemCommand="dtlCategory_ItemCommand">
                <ItemTemplate>
                            ...
                            <td class="formtd">
                                <div>
                                    ...
                                    <div class="form_box clearfix">
                                        <span class="alignleft" style="padding:8px 0px;"><%# Eval("CategoryName")%></span>
                                        <span class="alignright">
                                            <asp:LinkButton ID="lnkDelete" CommandName="deletevalue" CommandArgument='<%# Eval("CategoryID")%>'
                                        ...
                                        <span class="alignright">
                                            <asp:LinkButton ID="lnkEdit" CommandName="editvalue" CommandArgument='<%# Eval("CategoryID")%>'
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <div class="label_bar">
                                                        <label style="display:inline;">
                                                            Category name :</label>
                                                        <asp:TextBox class="popup_input" ID="txtCategoryName" runat="server"></asp:TextBox>
                                                    </div>
