<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="BasicSupplierInformation.aspx.cs" Inherits="admin_Supplier_BasicSupplierInformation"
    Title="Supplier Employee Information" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
        ...
        <div class="form_table">
            <%-- <div class="form_box" style="width:30%">
            <span class="custom-sel label-sel-small" style="width:95%" >
                <asp:DropDownList ID="ddlEmployeeType" runat="server" onchange="pageLoad(this,value);" TabIndex="18" >
            ...
            <table class="checktable_supplier true">
                <tr>
                    <%--<td class="formtd">
                        <span class="custom-checkbox alignleft" id="spChksDirectEmployee" runat="server">
                           
                            <asp:CheckBox ID="chkIsDirectEmployee" runat="server" />
                            </span>
                            <label>Direct Company Employee</label>
                    </td>
                    <td>
                        <span class="custom-checkbox alignleft" id="spChkIndependentContractor" runat="server">
                            <asp:CheckBox ID="ChkIndependentContractor" runat="server" />
                            </span><label>Independent Contractor</label>
                    </td>--%>
                    <td>
                        <div>
                            <div class="form_top_co">
