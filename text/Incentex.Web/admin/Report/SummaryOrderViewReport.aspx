<%@ Page Title="Summary Order View Report" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="SummaryOrderViewReport.aspx.cs" Inherits="admin_Report_SummaryOrderViewReport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
            ...
            <div class="black_middle">
                <table class="form_table">
                        ...
                        <td class="formtd">
                            <div>
                                <div class="form_top_co">
                                    <span>&nbsp;</span></div>
                                <div class="form_box">
                                    <span class="input_label">OrderNumber</span>
                    ...
                    <tr>
                        ...
                        <td class="formtd_r btn_w_block">
                            <asp:LinkButton ID="lnkSubmitRequest" Style="margin: 0px;" class="gredient_btn1 showloader"
        ...
        <div>
            <div class="header_bg">
                <div class="header_bgr clearfix">
                    <span class="title alignleft">Summary Order View</span>
                </div>
            </div>
            <div style="text-align: right; margin: 10px 0px;">
                Record Count:
                <asp:Label runat="server" ID="lblSummaryOrderViewRecordCounter" Text="0"></asp:Label>
            </div>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:HiddenField runat="server" ID="hdnAssociateTicketID" Value='<%# Eval("AssociateServiceTicketID") %>' />
        ...
        <asp:Panel ID="pnlOrderNote" runat="server" Style="display: none;">
            <div class="cboxWrapper" style="display: block; width: 450px; position: fixed; height: 550px;
                left: 35%; top: 8%;">
                <div style="">
        ...
        <asp:Panel ID="pnlCustomerMessage" runat="server" Style="display: none;">
            <div class="credboxWrapper" style="display: block; width: 450px; height: 600px; position: fixed;
                left: 35%; top: 3%;">
                <div style="">
