<%@ Page Title="Order Management Dashboard" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="OrderManagementReport.aspx.cs" Inherits="admin_Report_OrderManagementReport" %>
    ...
    <div class="form_pad">
        ...
        <div id="dvOrderAtAGlance" runat="server" visible="false">
            ...
            <div class="black_middle" style="text-align: center;">
                <asp:Chart ID="chrtOrderAtAGlance" runat="server" OnClick="chrtOrderAtAGlance_Click"
                    BackColor="Transparent" Height="600" Width="900">
                    <Series>
                        <asp:Series Name="Series1" ChartType="Pie" XValueMember="Status" PostBackValue="#VALX"
        ...
        <div id="dvSummaryDropShipReport" runat="server" visible="false">
            <div>
                <asp:LinkButton ID="lnkPrint" runat="server" CssClass="grey2_btn alignright" OnClick="lnkPrint_Click"><span>
                    Print</span></asp:LinkButton>
            </div>
            <div class="header_bg">
                <div class="header_bgr clearfix">
                    <span class="title alignleft">Summary Drop-Ship Report</span>
                </div>
            </div>
            <div style="text-align: right; margin-bottom: 10px;">
                Record Count:
                <asp:Label runat="server" ID="lblDropShipRecordCounter" Text="0"></asp:Label>
            </div>
            <asp:Repeater ID="rptDropShipSummary" runat="server">
                <ItemTemplate>
                    <div class="black_top_co">
                        <span>&nbsp;</span></div>
                    <div class="black_middle" style="text-align: center;">
                        ...
                        <table>
                            <tr>
                                <td class="alignleft">
                                    <span>Drop-Ship Order Items</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <asp:GridView ID="grdItemDetail" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="ord_header"
                                        ...
                                        <Columns>
                                            <asp:TemplateField>
                                                ...
                                                <HeaderStyle />
                                                <ItemTemplate>
                                                    <asp:HiddenField runat="server" ID="hdnMyShoppingCartID" Value='<%# Eval("MyShoppingCartID") %>' />
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <HeaderStyle CssClass="centeralign" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDescription" runat="server" Text='<%#(Eval("Description").ToString().Length > 75) ? Eval("Description").ToString().Substring(0, 75) + "..." : Eval("Description")%>'
                                                        ToolTip='<%# Eval("Description") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle CssClass="b_box" Width="55%" />
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <span>Retail</span>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <HeaderStyle CssClass="centeralign" />
                                                <ItemTemplate>
                                                    <span class="custom-checkbox alignleft btn_space" id="spnReference" runat="server">
                                                        <asp:CheckBox ID="chkReference" runat="server" AutoPostBack="true" OnCheckedChanged="chkReference_CheckedChanged" />
                                                    </span>
                                                    <asp:HiddenField ID="hdnReference" runat="server" Value='<%# Eval("Status") %>' />
                                                </ItemTemplate>
                                                <ItemStyle CssClass="b_box centeralign checktable_supplier true" Width="5%" />
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                </td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="grdReferenceDetail" runat="server" AutoGenerateColumns="false"
                                        HeaderStyle-CssClass="ord_header" CssClass="orderreturn_box" GridLines="None"
                                        RowStyle-CssClass="ord_content" Width="30%">
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <span>IE Name</span>
                                                ...
                                                <HeaderStyle />
                                                <ItemTemplate>
                                                    <asp:Label CssClass="first" runat="server" ID="lblIEName" Text='<%# Eval("IEName") %>' />
                                                    <div class="corner">
                                                        <span class="ord_greytop_cl"></span><span class="ord_greybot_cl"></span>
                                                    </div>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <HeaderStyle CssClass="centeralign" />
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDate" runat="server" CssClass="last" Text='<%# Eval("UpdatedDate") %>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle CssClass="g_box centeralign" Width="18%" />
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                </td>
