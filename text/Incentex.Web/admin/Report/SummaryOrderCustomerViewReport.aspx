<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="SummaryOrderCustomerViewReport.aspx.cs" Inherits="admin_Report_SummaryOrderCustomerViewReport"
    Title="Summary Order Customer View Report" %>
        ...
        function CallFunctionWhenClick(ItemID,CtrlID)
        {
            ...
            //alert("MainDiv");
                if(!$("#" + CtrlID).hasClass("setopen"))
                {
                    ...
                    $('#dvLoader').show();
                    __doPostBack("ctl00$ContentPlaceHolder1$rpCustomer$ctl0" + ItemID + "$lnkSelect",'');
                }
                else
                {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HiddenField ID="hfTempCustomerID" runat="server" />
    ...
    <div class="form_pad">
        <asp:Repeater ID="rpCustomer" runat="server" OnItemDataBound="rpCustomer_ItemDataBound">
            <ItemTemplate>
                <div class="collapsibleContainer MainContainer" title='<%# Eval("Name") %>' id="divHead"
                    runat="server">
                    <div class="black_top_co">
                        <span>&nbsp;</span></div>
                    <div class="black_middle">
                        <asp:LinkButton ID="lnkSelect" runat="server" CommandArgument='<%# Eval("UserId") %>'
                            CommandName="CustomerName" CssClass="customername" OnClick="lnkSelect_Click"></asp:LinkButton>
                        <!-- Main Body Content from the Summary Order View Page -->
                        <div style="text-align: right; margin: 10px 0px;">
                            Record Count:
                            <asp:Label runat="server" ID="lblCustomerOrderCounter" Text="0"></asp:Label>
                            <asp:HiddenField runat="server" ID="hfCustomerID" Value='<%# Eval("UserID") %>' />
                        </div>
    ...
    <asp:Panel ID="pnlOrderNote" runat="server" Style="display: none;">
        <div class="cboxWrapper" style="display: block; width: 450px; position: fixed; left: 35%;
            ...
            <div style="clear: left;">
                ...
                <div id="cboxContent" style="float: left; display: block; height: 450px; width: 400px;">
                        ...
                        <div style="margin-top: 30px;">
                            <table class="form_table" cellpadding="0" cellspacing="0">
                                ...
                                <tr runat="server" id="tr5" class="checktable_supplier true">
                                    <td>
                                        <span class="custom-checkbox" id="Span1" runat="server" style="float: left;">
