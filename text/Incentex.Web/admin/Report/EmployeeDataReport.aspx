<%@ Page Title="Employee Information Dashboard" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="EmployeeDataReport.aspx.cs" Inherits="admin_Report_EmployeeDataReport" %>
    ...
    <div class="form_pad">
        ...
        <div id="dvEmployeeByStation" runat="server" visible="false">
            ...
            <div class="black_middle" style="text-align: center;">
                <asp:Chart ID="chrtEmployeeByStation" runat="server" OnClick="chrtEmployeeByStation_Click"
                    BackColor="Transparent" Height="650" Width="900">
                    <Series>
                        <asp:Series Name="Series1" ChartType="Pie" XValueMember="Text" PostBackValue="#VALX"
                            LabelPostBackValue="#VALX" YValueMembers="Value" ToolTip="#VALX : #VALY" CustomProperties="DrawingStyle=Pie,
        ...
        <div id="dvEmployeeByGender" runat="server" visible="false">
            ...
            <div class="black_middle" style="text-align: center;">
                <asp:Chart ID="chrtEmployeeByGender" runat="server" OnClick="chrtEmployeeByGender_Click"
                    BackColor="Transparent" Height="400" Width="600">
                    <Series>
        ...
        <div id="dvEmployeeByStatus" runat="server" visible="false">
            ...
            <div class="black_middle" style="text-align: center;">
                <asp:Chart ID="chrtEmployeeByStatus" runat="server" OnClick="chrtEmployeeByStatus_Click"
                    Palette="None" BackColor="Transparent" Height="400" Width="600">
                    <Series>
                        <asp:Series Name="Series1" ChartType="Pie" XValueMember="Text" YValueMembers="Value"
                            PostBackValue="#VALX" LabelPostBackValue="#VALX" ToolTip="#VALX : #VALY" CustomProperties="DrawingStyle=Pie,PieDrawingStyle=Concave,PieLabelStyle=Outside,
                            PieLineColor=Gray,LabelsRadialLineSize=1, LabelsHorizontalLineSize=1" IsValueShownAsLabel="True"
        ...
        <div style="float: right; position: relative; top: -30px; right: 10px;">
            Total Employee :
            <asp:Label runat="server" ID="lblTotalEmployee"></asp:Label>
        </div>
    </div>
</asp:Content>
