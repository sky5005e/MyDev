<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="CreateCampaignStep4.aspx.cs" Inherits="admin_CommunicationCenter_CreateCampaignStep4"
            ...
            <div>
                ...
                <div class="black_middle">
                    ...
                    <div>
                        ...
                        <div>
                            <asp:Panel runat="server" ID="pnlPreview" ScrollBars="Both" Height="600px" Width="550px">
                                <asp:Label ID="TxtEmailText" runat="server" CssClass="w_label" Height="600px" Width="550px"></asp:Label>
                            </asp:Panel>
                        </div>
                        <br />
                        <table>
                            ...
                            <tr id="tdUpload" runat="server">
                                <td>
                                    <div>
                                        <div class="form_box">
                                            <asp:GridView ID="grv" runat="server" Width="60%" AutoGenerateColumns="False"  
                                                OnRowDeleting="grv_RowDeleting" ShowHeader="False">
                                                <Columns>
                                            ...
                                            <div class="noteIncentexthumb" style="width: 100%; font-size: 12px;">
                                                ...
                                                file formats are <b>.pdf | .doc | .png | .jpeg | .jpg | .gif </b>
                                            </div>
                                            <br />
                                            <div class="noteIncentexthumb" style="width: 100%; font-size: 12px;">
                                                <img src="../../Images/lightbulb.gif" style="z-index: -1" alt="note:" />
                    ...
                    <%--</div>--%>
                    <asp:LinkButton ID="lnkSendMail" class="grey2_btn alignright" runat="server" OnClick="lnkSendMail_Click"><span>Send Test Now</span></asp:LinkButton>
                    <%-- <a href="#" class="grey2_btn alignright" title="Send Password Now"><span>Send Password
                    Now</span></a>--%>
                    <div class="alignnone">
                    </div>
                </div>
