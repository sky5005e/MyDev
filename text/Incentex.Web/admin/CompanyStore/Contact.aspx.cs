...
public partial class admin_CompanyStore_Contact : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {   
                ...
                menuControl.PopulateMenu(7, 0, this.CompanyStoreId, 0, false);
    ...
    public void getcontactbystore()
    {
        ...
        List<CompanyStoreDocumentRepository.ContactExtension> objExtList = objRep.GetAllContactByStoreId(this.CompanyStoreId);
