<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="StoreCostCenterCodes.aspx.cs" Inherits="StoreCostCenterCodes" Title="Store CostCenterCode" %>
        ...
        $().ready(function() {
            ...
            $.get('../../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    ...
                    messages: {
                        ctl00$ContentPlaceHolder1$txtCode: {
                            required: "<br/>" + replaceMessageString(objValMsg, "Required", "Cost-Center Code")
        ...
        <ContentTemplate>
            <div class="form_pad">
                <div>
                    ...
                    <br />
                    <br />
                    <asp:DataList ID="dtstorecode" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                        OnItemCommand="dtstorecode_ItemCommand" OnItemDataBound="dtstorecode_ItemDataBound">
                        <ItemTemplate>
                                        ...
                                        <div>
                                            ...
                                            <div class="form_box clearfix dropdown_search">
                                                <span class="alignleft status_detail">
                                                    <asp:Literal ID="txtCode" runat="server" Text='<%# Eval("Code")%>'></asp:Literal>
                                                </span><span class="alignright">
                                                    <asp:LinkButton ID="lnkCostCenterCodeID" CommandName="deletevalue" CommandArgument='<%# Eval("CostCenterCodeID")%>'
                                                    ...
                                                    <asp:LinkButton ID="lnkEdit" CommandName="editvalue" CommandArgument='<%# Eval("CostCenterCodeID")%>'
                                                    ...
                                                    <div class="pp_inline clearfix">
                                                        <div class="form_popup_box">
                                                            ...
                                                            <div class="label_bar">
                                                                ...
                                                                <asp:TextBox class="popup_input" ID="txtCode" MaxLength="20" runat="server"></asp:TextBox><span
                                                                    id="duplicate"></span>
                                                            </div>
