            ...
            $.get('../../../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    ...
                    errorPlacement: function(error, element) {
                        if (element.attr("name") == "ctl00$ContentPlaceHolder1$txtEstimatedDateHired")
                            ...
                            <div>
                                ...
                                <div class="form_box shipmax_in">
                                    <span class="input_label max_w">Estimated Date Hired</span> <span class="outer_dateimg">
                                        ...
                                        <asp:TextBox ID="txtEstimatedDateHired" runat="server" CssClass="datepicker w_label min_w"></asp:TextBox>
                                    </span>
                                </div>
                                <div class="form_bot_co">
                                    <span>&nbsp;</span></div>
                            ...
                            <div>
                                ...
                                <div class="form_box clearfix employer_text">
                                    ...
                                    <div class="textarea_box alignright">
                                        ...
                                        <asp:TextBox ID="txtPreviousEmployer" runat="server" CssClass="scrollme2" TextMode="MultiLine"
                                            Rows="2"></asp:TextBox>
                                        ...
                                        <div>
                                            ...
                                            <div class="form_box clearfix child_text">
                                                ...
                                                <div class="textarea_box alignright">
                                                    ...
                                                    <asp:TextBox ID="txtChildrensName" runat="server" CssClass="scrollme3" TextMode="MultiLine"
                                                        Rows="2"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form_bot_co">
