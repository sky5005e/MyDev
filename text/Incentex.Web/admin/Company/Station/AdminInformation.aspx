<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="AdminInformation.aspx.cs" Inherits="admin_Company_Station_AddAdminInformation" %>
        ...
        $().ready(function() {
            $.get('../../../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    ...
                    , ctl00$ContentPlaceHolder1$txtEstimatedDate: { date: true }
                    ...
                    , ctl00$ContentPlaceHolder1$txtMobile: { 
                        ...
                        , ctl00$ContentPlaceHolder1$txtEstimatedDate: { date: replaceMessageString(objValMsg, "ValidDate", "") }
                        , ctl00$ContentPlaceHolder1$txtBirthdate: { date: replaceMessageString(objValMsg, "ValidDate", "") }
                    },
                    errorPlacement: function(error, element) {
                        if (element.attr("name") == "ctl00$ContentPlaceHolder1$txtEstimatedDate")
                            error.insertAfter("#dvEstimated");
                         else if (element.attr("name") == "ctl00$ContentPlaceHolder1$txtBirthdate")
                            error.insertAfter("#dvBirthdate");
                        else
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <div class="form_box">
                                                ...
                                                <asp:TextBox ID="txtTitle" runat="server" CssClass="w_label"></asp:TextBox>
                                            </div>
                                            <div class="form_bot_co">
                                                <span>&nbsp;</span></div>
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <div class="form_box">
                                                ...
                                                <asp:TextBox ID="txtTel" runat="server" CssClass="w_label"></asp:TextBox>
                                            </div>
                                            <div class="form_bot_co">
                                                <span>&nbsp;</span></div>
                                        </div>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <div class="form_box">
                                                ...
                                                <asp:TextBox ID="txtEmail" runat="server" CssClass="w_label"></asp:TextBox>
                                            </div>
                                            <div class="form_bot_co">
                                                <span>&nbsp;</span></div>
                                        </div>
                                            ...
                                            <div class="upload_photo">
                                                ...
                                                <div id="dvPriPhotoContainer" class="upload_photo  gallery" runat="server">
                                                    <a href="../../../images/upload-img-splash.jpg" rel='prettyPhoto'>
                                                        <img src="../../../images/upload-img-splash.jpg" width='140' height='161' id="imgPhotoupload"
                                                            alt="" /></a>
                                                </div>
                                            </div>
                        ...
                        <td class="formtd_left">
                            <div>
                                ...
                                <div class="form_box shipmax_in">
                                    <span class="input_label max_w">Estimated Date Hired</span> <span class="outer_dateimg">
                                        <%--<input type="text"  class="datepicker w_label min_w"/>--%>
                                        <asp:TextBox ID="txtEstimatedDate" runat="server" CssClass="datepicker w_label min_w"></asp:TextBox>
                                    </span>
                                </div>
                                <div class="form_bot_co">
                                    <span>&nbsp;</span></div>
                            ...
                            <div>
                                ...
                                <div class="form_box clearfix employer_text">
                                    ...
                                    <div class="textarea_box alignright">
                                        <div class="scrollbar">
                                            <a href="#scroll" id="Scrolltop4" class="scrolltop"></a><a href="#scroll" id="ScrollBottom4"
                                                class="scrollbottom"></a>
                                        </div>
                                        <%--<textarea name="" cols="" rows="" class="scrollme4"></textarea>--%>
                                        <asp:TextBox ID="txtPreviousEmployer" runat="server" CssClass="scrollme4" TextMode="MultiLine"
                                            Rows="2"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form_bot_co">
                                    ...
                                    <td class="formtd_left">
                                        <div>
                                            ...
                                            <div class="form_box">
                                                ...
                                                <asp:TextBox ID="txtSpouseName" runat="server" CssClass="w_label"></asp:TextBox>
                                            </div>
                                            <div class="form_bot_co">
                                                <span>&nbsp;</span></div>
                                        </div>
                                    ...
                                    <td class="formtd_right">
                                        <div>
                                            <div class="form_top_co">
                                                <span>&nbsp;</span></div>
                                            <div class="form_box">
                                                <span class="input_label">Birthdate</span> <span class="outer_dateimg">
                                                    <asp:TextBox ID="txtBirthdate" runat="server" CssClass="datepicker w_label min_w"></asp:TextBox>
                                                </span>
                                            </div>
                                            <div class="form_bot_co">
                                                <span>&nbsp;</span></div>
                                    ...
                                    <td class="formtd_left">
                                        <div>
                                            ...
                                            <div class="form_box clearfix child_text">
                                                ...
                                                <div class="textarea_box alignright">
                                                    <div class="scrollbar">
                                                        <a href="#scroll" id="Scrolltop5" class="scrolltop"></a><a href="#scroll" id="ScrollBottom5"
                                                            class="scrollbottom"></a>
                                                    </div>
                                                    <%--<textarea name="" cols="" rows="" class="scrollme5"></textarea>--%>
                                                    <asp:TextBox ID="txtChildrensName" runat="server" CssClass="scrollme5" TextMode="MultiLine"
                                                        Rows="2"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form_bot_co">
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder3" runat="server" ID="PopUp">
    ...
    <div id="dvUpload" style="display: none;">
        <form id="frmUploadPri" method="post" action="../../controller/UploadPhoto.aspx"
        ...
        <div class="tbl_row">
            <div class="note" style="width: 100%;">
                <img src="../../../Images/lightbulb.gif" alt="note:" />&nbsp;Please upload your
                photo. You can upload jpg, gif, bmp and png image files.</div>
        </div>
        <div class="cl spacer">
        </div>
        <div class="cl spacer">
