<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="UserReports.aspx.cs" Inherits="admin_Company_Employee_UserReports"
    Title="Company Employee >> User Reports" %>
 ...
 <script type="text/javascript" language="javascript">
    $().ready(function() {
        $.get('../../../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
            ...
            $("#aspnetForm").validate({
                rules: {
                    ctl00$ContentPlaceHolder1$ddlParentReports: { NotequalTo: "0" }
                },
                messages: {
                    ctl00$ContentPlaceHolder1$ddlParentReports: { NotequalTo: replaceMessageString(objValMsg, "NotEqualTo", "report type") }
                },
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad" id="dvCompanyAdmin" runat="server">
        <div class="form_table" style="width: 600px; margin: 0 auto;">
                    ...
                    <div class="form_box">
                        ...
                        <label class="dropimg_width212">
                            <span class="custom-sel label-sel">
                                <asp:DropDownList ID="ddlParentReports" onchange="pageLoad(this,value);" runat="server"
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlParentReports_SelectedIndexChanged">
                                </asp:DropDownList>
                            </span>
                        </label>
                    </div>
            ...
            <div id="dvSubReport" runat="server" visible="false">
                <h4>
                    Select Sub Report :
                </h4>
                <asp:GridView ID="gvSubReport" runat="server" ShowHeader="false" AutoGenerateColumns="false"
                                    ...
                                    <div>
                                        ...
                                        <div class="bl_middle_bo">
                                            <div style="height: 36px">
                                                <asp:HiddenField ID="hdnSubReportID" runat="server" Value='<%#Eval("iLookupID") %>' />
                                                <span>
                                                    <%#Eval("sLookupName") %>
                                                </span>
                                            </div>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <div class="wheather_check " runat="server" id="dvChkSubReport">
                                    <asp:CheckBox ID="chkSubReport" runat="server" />
                                </div>
                            </ItemTemplate>
            ...
            <div id="dvPriceLevel" runat="server" visible="false">
                <h4>
                    Select Price Level :
                </h4>
                <asp:DataList ID="dtPriceLevel" RepeatDirection="Horizontal" runat="server" CssClass="checktable_supplier true">
                    <ItemTemplate>
                        <span class="custom-checkbox alignleft" id="spnPriceLevel" runat="server">
                            <asp:CheckBox ID="chkPriceLevel" runat="server" />
                        </span>
                        <label>
                            <asp:Label ID="lblPriceLevel" Text='<%# Eval("sLookupName") %>' runat="server"></asp:Label></label>
                            <asp:HiddenField ID="hdnSPriceLevel" runat="server" Value='<%#Eval("Val1")%>' />
                    </ItemTemplate>
                </asp:DataList>
            </div>
            <div class="alignnone spacer25">
            </div>
            <div id="dvWorkgroup" runat="server" visible="false">
                <h4>
                    Select Work Group :
                </h4>
                <asp:GridView ID="gvWorkGroup" runat="server" ShowHeader="false" AutoGenerateColumns="false"
                    GridLines="None" CssClass="weather_box">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <div class="wheather_check " runat="server" id="dvChkWorkgroup">
                                    <asp:CheckBox ID="chkWorkgroup" runat="server" />
                                </div>
                            </ItemTemplate>
                            <ItemStyle CssClass="rightalign" />
                        </asp:TemplateField>
    ...
    <div class="form_pad" id="dvCompanyEmployee" runat="server">
        <div style="text-align: center">
            <label class="errormessage">This tab is disabled for company employee!!</label>
        </div>
    </div>
    <div class="form_pad" id="dvRights" runat="server">
        <div style="text-align: center">
            <label class="errormessage">You have no rights to view this page!!</label>
        </div>
    </div>
</asp:Content>
