<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ListArtworkLibrary.aspx.cs" Inherits="admin_ArtWorkDecoratingLibrary_ListArtworkLibrary" %>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <span class="first btn_space">
                            <asp:HyperLink ID="lnkArtDesignNumber" runat="server" NavigateUrl='<%# "~/admin/ArtWorkDecoratingLibrary/ArtworkPreview.aspx?Id=" + Eval("ArtworkID").ToString()%>'
