<%@ Page Title="Incentex Employee >> Report Access Rights" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="UserReports.aspx.cs" Inherits="admin_IncentexEmployee_UserReports" %>
    ...
    <div class="form_pad">
        <div id="dvRights" runat="server">
            <div class="form_table" style="width: 600px; margin: 0 auto;">
                ...
                <div id="dvStore" runat="server" visible="false">
                    <h4>
                        Select Store :
                    </h4>
                    <asp:GridView ID="gvStore" runat="server" ShowHeader="false" AutoGenerateColumns="false"
                        GridLines="None" CssClass="weather_box">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div class="wheather_check " runat="server" id="dvChkStore">
                ...
                <div id="dvBaseStation" runat="server" visible="false">
                    ...
                    <div class="weather_box">
                        <span class="wheather_check " style="float: right; margin-right: 7px; margin-bottom: 10px;"
                            id="dvChkBaseStationAll">
        ...
        <div id="dvNoRights" runat="server">
            <div style="text-align: center">
                <label class="errormessage">
                    You have no rights to view this page!!</label>
            </div>
        </div>
    </div>
</asp:Content>
