<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="vLookupMasterItemNo.aspx.cs" Inherits="vLookupMasterItemNo" Title="World-Link System - Dropdown Listing" %>
                ...
                $("#aspnetForm").validate({
                    ...
                    messages: {
                        ...
                        ctl00$ContentPlaceHolder1$ddlGender: {
                            NotequalTo: "<br/>" + replaceMessageString(objValMsg, "NotEqualTo", "Gender")
                        },
                        ctl00$ContentPlaceHolder1$flFile: {
                                        ...
                                        <div>
                                            ...
                                            <div class="form_box clearfix dropdown_search">
                                                <span class="alignleft status_detail">
                                                    <asp:HiddenField ID="hdnLookupIcon" Value='<%# DataBinder.Eval(Container.DataItem, "sLookupIcon")%>'
                                                        runat="server" />
                                                        ...
                                                        <div class="form_popup_box">
                                                            ...
                                                            <div class="label_bar">
                                                                <label>
                                                                    Gender :</label>
                                                                <span>
                                                                    <asp:DropDownList class="popup_input" ID="ddlGender" runat="server" AppendDataBoundItems="True">
                                                                        <asp:ListItem Value="0">-Select-</asp:ListItem>
                                                                        <asp:ListItem Value="F">Female</asp:ListItem>
                                                                        <asp:ListItem Value="M">Male</asp:ListItem>
                                                                        <asp:ListItem Value="U">UniSex</asp:ListItem>
