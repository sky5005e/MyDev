<%@ Page Title="Employee Training Center" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="ListEmployeeTrainingCenter.aspx.cs" Inherits="admin_EmployeeTrainingCenter_ListEmployeeTrainingCenter" %>
        ...
        <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="ord_header"
            ...
            <Columns>
                <asp:TemplateField Visible="false">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblArtworkID" Text='<%# Eval("EmployeeTrainingCenterID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField SortExpression="FileSize">
                    ...
                    <ItemTemplate>
                        ...
                        <img id="imgyoutube" visible="false" runat="server" style="width: 30px;" src="../../Images/YouTubeLogo.png"
                            alt="youtub" />
                    </ItemTemplate>
                    <ItemStyle CssClass="b_box" />
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <span>
                            <asp:LinkButton ID="lnkSendEmail" runat="server" CommandArgument='<%# Eval("EmployeeTrainingCenterID") %>'
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <span>
                            ...
                            <asp:LinkButton ID="lnkbtnPlay" CommandName="PlayVideo" CssClass="btn_space" CommandArgument='<%# Eval("EmployeeTrainingCenterID") %>'
                                runat="server">
                                <img alt="->" id="play" src="~/Images/play.png" runat="server" /></asp:LinkButton>&nbsp;
                        </span>
                    </ItemTemplate>
                    ...
                    <ItemTemplate>
                        <span>
                            <asp:LinkButton ID="lnkbtndelete" CommandName="DeleteTraining" OnClientClick="return Loadloder();"
                                CommandArgument='<%# Eval("EmployeeTrainingCenterID") %>' runat="server" class="btn_space">
                    ...
                    <div id="cboxLoadedContent" style="display: block;">
                        <div style="padding: 10px;">
                            ...
                            <div class="centeralign" style="margin-top: 15px;">
                                <asp:LinkButton ID="btnSubmit" CssClass="grey2_btn" runat="server" OnClientClick="$('#dvLoader').show();"
