<%@ Page Title="Employee Training Center" Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master"
    AutoEventWireup="true" CodeFile="AddEmployeeTrainingType.aspx.cs" Inherits="admin_EmployeeTrainingCenter_AddEmployeeTrainingType" %>
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            $.get('../../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: { ctl00$ContentPlaceHolder1$txtEmployeeTrainingType: { required: true },
                    ctl00$ContentPlaceHolder1$txtpassword: { minlength: 4 }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtEmployeeTrainingType: { required: replaceMessageString(objValMsg, "Required", "Employee Training Type") },
            ...
            <table>
                    ...
                    <td>
                        <div>
                            <div class="form_top_co">
                                <span>&nbsp;</span></div>
                            <div class="form_box">
                                <span class="input_label" style="width: 35%;">Training Video Type </span>
                                <asp:TextBox ID="txtEmployeeTrainingType" TabIndex="1" runat="server" CssClass="w_label"></asp:TextBox>
                            </div>
                ...
                <tr>
                    <td class="centeralign">
                        <asp:LinkButton ID="lnkBtnSaveInfo" TabIndex="3" class="grey2_btn" runat="server" ToolTip="Save Training Video Type"
