<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Vendorsignup.aspx.cs" Inherits="Vendorsignup" Title="World-Link System - Signup" %>
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            $.get('JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtCompanyCode: { required: true, remote: "controller/CheckCompanyCodeAvailable.aspx" },
                    ...
                    messages: {
                        ctl00$ContentPlaceHolder1$txtCompanyCode: { required: replaceMessageString(objValMsg, "Required", "company code"), remote: "Please enter valid company code" },
                ...
                $("#ctl00_ContentPlaceHolder1_txtEmail").blur(function() {
                    $.ajax({
                        type: "POST",
                        url: "Vendorsignup.aspx/CheckDuplicateEmail",
                        data: "{'email':'" + $(this).val() + "'}",
                ...
                $("#ctl00_ContentPlaceHolder1_txtEmployeeId").blur(function() {
                    $.ajax({
                        type: "POST",
                        url: "Vendorsignup.aspx/CheckDuplicateEmployeeID",
                        data: "{'employeeID':'" + $(this).val() + "', 'companyID':'" + $("#ctl00_ContentPlaceHolder1_hdnCompanyID").val() + "'}",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function(msg) {
                ...
                $('#<%=txtCompanyCode.ClientID %>').change(function() {
                    ...
                    var companyid = companycode.substring(0, companycode.indexOf('-'));
                    var workgroupid = companycode.substring((companycode.indexOf('-', (companycode.indexOf('-') + 1)) + 1), (companycode.split("-").length - 1) > 2 ? companycode.lastIndexOf('-') : companycode.length);
                    $("#ctl00_ContentPlaceHolder1_hdnCompanyID").val(companyid);
                    $.post("controller/ajaxopes.aspx",
                    {
                        mode: 'CHECKIFHIREDDATE',
                        imgname: workgroupid,
                        compid: companyid
                    },
                    function(sRet) {
                        ...
                        if (returnval == "true") {
                            ...
                            document.getElementById("<%=trHireDate.ClientID%>").style.display = "";

                            $("#ctl00_ContentPlaceHolder1_txtHireDate").rules("add", {
                                required: true,
                                messages: {
                            ...
                            document.getElementById("<%=trHireDate.ClientID%>").style.display = "none";

                            $("#ctl00_ContentPlaceHolder1_txtHireDate").rules("remove");
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
        ...
        <div class="not_yet_pad">
            <table class="form_table">
                ...
                <tr id="trThirdPartyCompanyName" runat="server">
                    <td>
                        <div>
                            <div class="form_top_co">
                                <span>&nbsp;</span></div>
                            <div class="form_box">
                                <span class="input_label">Vendor Company Name</span>
                                <asp:TextBox ID="txtCompanyName" MaxLength="100" runat="server" CssClass="w_label"></asp:TextBox>
                            </div>
                            <div class="form_bot_co">
                                <span>&nbsp;</span>
                            </div>
                    ...
                    <td>
                        <div>
                            <div class="form_top_co">
                                <span>&nbsp;</span></div>
                            <div class="form_box">
                                <span class="input_label">Company Code</span>
                                <asp:TextBox ID="txtCompanyCode" runat="server" CssClass="w_label"></asp:TextBox>
                            </div>
                            <div class="form_bot_co">
                                <span>&nbsp;</span>
                            </div>
                    ...
                    <td>
                        <div class="calender_l">
                            <div class="form_top_co">
                                <span>&nbsp;</span></div>
                            <div class="form_box">
                                <span class="input_label" style="width: 25%;">Hire Date</span>
    ...
    <input id="hdnCompanyID" type="hidden" value="0" runat="server" />
</asp:Content>
