<%@ Page Title="New Products List" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="NewProductList.aspx.cs" Inherits="Products_NewProductList" %>
                    ...
                    <div class="uniform_price clearfix">
                        ...
                        <table>
                            <tr>
                                <td colspan="2">
                                    <div>
                                        <%--<a href="#" class="grey2_btn" title="Detail"><span>Details</span></a>--%>
