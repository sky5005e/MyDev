...
public partial class Products_SaleProductList : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ((Label)Master.FindControl("lblPageHeading")).Text = "Sale Products List";
    ...
    protected void lstProductList_DataBinding(object sender, EventArgs e)
    {
        ...
        objList = objStoreProductRepository.GetSaleStoreProductItems((Int64)IncentexGlobal.CurrentMember.CompanyId, (Int64)objCmpnyInfo.WorkgroupID, (Int64)IncentexGlobal.CurrentMember.UserInfoID);
        ...
        //End Update 21-Nov-2011 Nagmani


    }
    //Added By Ankit on (21-Jan-11)
    ...
    protected void lstProductList_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            case "Detail":
                Response.Redirect("SaleProductDetail.aspx?MasterItemNo=" + e.CommandArgument + /*"&SubCat=" + this.PSubCategoryName +*/ "&StoreProductId=" + ((HiddenField)e.Item.FindControl("hndStoreProductImageId")).Value.ToString());
                break;
        }
    }
