<%@ Page Title="Store >> Contact Us" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="ViewContact.aspx.cs" Inherits="CompanyStore_ViewContact" %>
                            ...
                            <div>
                                ...
                                <div id="dvPriPhotoContainer" class="upload_photo gallery">
                                    <a href='<%# SetImages(Eval("Image")) %>' rel='prettyPhoto'>
                                        <img id="imgPhotoupload" src='<%# SetImages(Eval("Image")) %>' alt="Contact" width='140'
                                            height='161' />
                                    </a>
                                    <div class="spacer10">
                                    </div>
                                    <div>
                                        <p style="color: #92969F; font-family: Lucida Sans Unicode, Sans-Serif; font-size: 11px;">
