<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vLookupCategory.aspx.cs" Inherits="AssetManagement_vLookupCategory" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtProductCategoryName: {
                            required: true
                        }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtProductCategoryName: {
                            required: replaceMessageString(objValMsg, "Required", "Product Category name")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:DataList ID="dtlProductCategory" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                OnItemCommand="dtlProductCategory_ItemCommand">
                <ItemTemplate>
                            ...
                            <td class="formtd">
                                <div>
                                    ...
                                    <div class="form_box clearfix">
                                        <span class="alignleft" style="padding:8px 0px;"><%# Eval("ProductCategoryName")%></span>
                                            ...
                                            <div class="pp_inline clearfix">
                                                <div class="form_popup_box">
                                                    ...
                                                    <div class="label_bar">
                                                        ...
                                                        <asp:TextBox class="popup_input" ID="txtProductCategoryName" runat="server"></asp:TextBox>
                                                    </div>
