<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vLookupProductSubCategory.aspx.cs" Inherits="AssetManagement_vLookupProductSubCategory" Title="Untitled Page" %>
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtProductSubCategory: {
                            required: true
                        }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtProductSubCategory: {
                            required: replaceMessageString(objValMsg, "Required", "Product Sub Category")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:Repeater ID="rptProductCategory" runat="server" OnItemDataBound="rptProductCategory_ItemDataBound">
                <ItemTemplate>
                    <div class="collapsibleContainer" title="<%# DataBinder.Eval(Container.DataItem, "ProductCategoryName")%>">
                        <div style="text-align: center">
                            <asp:Label ID="lblMsg" runat="server" CssClass="errormessage"></asp:Label>
                        </div>
                        <asp:HiddenField ID="hdnProductCategoryID" Value='<%# DataBinder.Eval(Container.DataItem, "ProductCategoryID")%>'
                            runat="server"></asp:HiddenField>
                        <asp:DataList ID="dtlProductSubCategory" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                            OnItemCommand="dtlProductSubCategory_ItemCommand">
                            <ItemTemplate>
                                            ...
                                            <div>
                                                ...
                                                <div class="form_box clearfix">
                                                    <span class="alignleft" style="padding: 8px 0px;">
                                                        <%# Eval("ProductCategoryName")%></span> <span class="alignright">
                                                            <asp:LinkButton ID="lnkDelete" CommandName="deletevalue" CommandArgument='<%# Eval("ProductCategoryID")%>'
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" CommandName="editvalue" CommandArgument='<%# Eval("ProductCategoryID")%>'
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <table cellpadding="10" cellspacing="10">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox class="popup_input" ID="txtProductSubCategory" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
