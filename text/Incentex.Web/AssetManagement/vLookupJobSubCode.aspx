<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vLookupJobSubCode.aspx.cs" Inherits="AssetManagement_vLookupJobSubCode" Title="Untitled Page" %>
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtSubJobCodeName: {
                            required: true
                        }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtSubJobCodeName: {
                            required: replaceMessageString(objValMsg, "Required", "subJobCode name")
                        }
                    }
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:Repeater ID="rptJobCode" runat="server" OnItemDataBound="rptJobCode_ItemDataBound">
                <ItemTemplate>
                    <div class="collapsibleContainer" title="<%# DataBinder.Eval(Container.DataItem, "JobCodeName")%>">
                        <div style="text-align: center">
                            <asp:Label ID="lblMsg" runat="server" CssClass="errormessage"></asp:Label>
                        </div>
                        <asp:HiddenField ID="hdnJobCodeID" Value='<%# DataBinder.Eval(Container.DataItem, "JobCodeID")%>'
                            runat="server"></asp:HiddenField>
                        <asp:DataList ID="dtlSubJobCode" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                            OnItemCommand="dtlSubJobCode_ItemCommand">
                            <ItemTemplate>
                                            ...
                                            <div>
                                                ...
                                                <div class="form_box clearfix">
                                                    <span class="alignleft" style="padding: 8px 0px;">
                                                        <%# Eval("JobCodeName")%></span> <span class="alignright">
                                                            <asp:LinkButton ID="lnkDelete" CommandName="deletevalue" CommandArgument='<%# Eval("JobCodeID")%>'
                                                            ...
                                                            <asp:LinkButton ID="lnkEdit" CommandName="editvalue" CommandArgument='<%# Eval("JobCodeID")%>'
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <table cellpadding="10" cellspacing="10">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox class="popup_input" ID="txtSubJobCodeName" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
