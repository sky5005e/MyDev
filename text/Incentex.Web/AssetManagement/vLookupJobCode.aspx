<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vLookupJobCode.aspx.cs" Inherits="AssetManagement_vLookupJobCode" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtJobCodeName: {
                            required: true
                        }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtJobCodeName: {
                            required: replaceMessageString(objValMsg, "Required", "JobCode name")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:DataList ID="dtlJobCode" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                OnItemCommand="dtlJobCode_ItemCommand">
                <ItemTemplate>
                            ...
                            <td class="formtd">
                                <div>
                                    ...
                                    <div class="form_box clearfix">
                                        <span class="alignleft" style="padding:8px 0px;"><%# Eval("JobCodeName")%></span>
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <div class="label_bar">
                                                        <label style="display:inline;">
                                                            JobCode name :</label>
                                                        <asp:TextBox class="popup_input" ID="txtJobCodeName" runat="server"></asp:TextBox>
                                                    </div>
