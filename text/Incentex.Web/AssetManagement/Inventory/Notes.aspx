<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Notes.aspx.cs" Inherits="AssetManagement_Inventory_Notes" Title="Untitled Page" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
        ...
        <div class="botbtn centeralign">
            <asp:LinkButton ID="lnkBtnNext" runat="server" CssClass="grey2_btn" TabIndex="19" OnClick="lnkBtnNext_Click">
								        <span>Next</span>
            </asp:LinkButton>
        </div>
    </div>
