<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Attachment.aspx.cs" Inherits="AssetManagement_Inventory_Attachment" Title="Attachment" %>
                    ...
                    <td class="centeralign">
                        ...
                        &nbsp;&nbsp;
                         <asp:LinkButton ID="btnNext" class="grey2_btn" runat="server" 
                             onclick="btnNext_Click" ><span>Next</span></asp:LinkButton>
                    </td>
                </tr>
                <tr><td>
                <div class="spacer20">
                                ...
                                <asp:GridView ID="gvEquipment" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="ord_header"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField SortExpression="DocumentDescription">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkbtnDocumentDescription" runat="server" CommandArgument="DocumentDescription" CommandName="Sort"><span >Document Description</span></asp:LinkButton>
