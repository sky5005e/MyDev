<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="MenuAccess.aspx.cs" Inherits="AssetManagement_MenuAccess" Title="Menu Access" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form_pad">
       ...
       <%-- <h4>
            GSE Asset Management Menu Access</h4>--%>
        <%--<div>
            <table>
                <tr>
                    <td >
                        <table class="checktable_supplier true">
                            <tr>
                                <td>
                                    <asp:DataList ID="dtlMenus" runat="server" RepeatColumns="3" 
                                        >
                                        <ItemTemplate>
        ...
        <div id="dvSubReport" runat="server" >
                <h4>
                   GSE Asset Management Menu Access :
                </h4>
