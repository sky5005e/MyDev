<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vSubLookupDropdown.aspx.cs" Inherits="AssetManagement_vSubLookupDropdown" Title="Untitled Page" %>
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                        ctl00$ContentPlaceHolder1$txtSubCategory: {
                            required: true
                        }
                    },
                    messages: {
                        ctl00$ContentPlaceHolder1$txtSubCategory: {
                            required: replaceMessageString(objValMsg, "Required", "Name")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:Repeater ID="rptCategory" runat="server" OnItemDataBound="rptCategory_ItemDataBound">
                <ItemTemplate>
                    <div class="collapsibleContainer" title="<%# DataBinder.Eval(Container.DataItem, "sLookupName")%>">
                        <div style="text-align: center">
                            <asp:Label ID="lblMsg" runat="server" CssClass="errormessage"></asp:Label>
                        </div>
                        <asp:HiddenField ID="hdnCategoryID" Value='<%# DataBinder.Eval(Container.DataItem, "iLookupID")%>'
                                            ...
                                            <div>
                                                ...
                                                <div class="form_box clearfix">
                                                    <span class="alignleft" style="padding: 8px 0px;">
                                                        <%# Eval("sLookupName")%></span> <span class="alignright">
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <table cellpadding="10" cellspacing="10">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox class="popup_input" ID="txtSubCategory" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
