<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ManageEquipment.aspx.cs" Inherits="AssetManagement_ManageEquipment" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Check">
                             ...
                             <asp:TemplateField Visible="False" HeaderText="EquipmentID">
                               <HeaderTemplate>
                                    <asp:LinkButton ID="lnkbtnEquipID" runat="server" CommandArgument="EquipmentID" 
                                        CommandName="Sort"><span style="text-align:center" >id#</span></asp:LinkButton>
                                    <asp:PlaceHolder ID="placeholderEquipID" runat="server"></asp:PlaceHolder>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField SortExpression="Status">
                             ...
                             <%--<asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:LinkButton ID="lnkbtnProfile" runat="server" CommandArgument="EquipmentTypeID"
                                        CommandName="Sort"><span >Profile</span></asp:LinkButton>
                                    <asp:PlaceHolder ID="placeholderProfile" runat="server"></asp:PlaceHolder>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    
                                        <asp:HyperLink ID="lnkProfile" CommandArgument='<%# Eval("EquipmentMasterID") %>' CommandName="Profile"
                                            runat="server" NavigateUrl='<%# "~/AssetManagement/AssetProfile.aspx?Id=" + Eval("EquipmentMasterID").ToString()%>'>
                                            <span>Profile</span>
                                            </asp:HyperLink>
