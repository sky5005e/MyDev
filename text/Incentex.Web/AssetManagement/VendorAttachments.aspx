<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="VendorAttachments.aspx.cs" Inherits="AssetManagement_VendorAttachments" Title="Attachments" %>
                    ...
                    <td class="centeralign">
                        ...
                        &nbsp;&nbsp;
                         <asp:LinkButton ID="lnkBtnEmployeeList" class="grey2_btn" runat="server" 
                            ToolTip="Employee List" onclick="lnkBtnEmployeeList_Click" ><span>Vendor List</span></asp:LinkButton>
                    </td>
                </tr>
                <tr><td>
                <div class="spacer20">
