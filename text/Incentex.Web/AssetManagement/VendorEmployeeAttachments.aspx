<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="VendorEmployeeAttachments.aspx.cs" Inherits="AssetManagement_VendorEmployeeAttachments" Title="Attachments" %>
            ...
            <table class="dropdown_pad ">
                 ...
                 <tr>
                    <td>
                        <div class="form_top_co">
                            <span>&nbsp;</span></div>
                        <div class="form_box">
                            <span class="input_label" style="width: 38%">Documents</span>
                ...
                <tr>
                    <td class="centeralign">
                        ...
                        &nbsp;&nbsp;
                        <%-- <asp:LinkButton ID="lnkBtnEmployeeList" class="grey2_btn" runat="server" 
                            ToolTip="Employee List" onclick="lnkBtnEmployeeList_Click" ><span>Employee List</span></asp:LinkButton>--%>
                                ...
                                <asp:GridView ID="gvEquipment" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="ord_header"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField SortExpression="Description">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkbtnDescription" runat="server" CommandArgument="Description" CommandName="Sort"><span >Document Description</span></asp:LinkButton>
                                                <asp:PlaceHolder ID="placeholderDescription" runat="server"></asp:PlaceHolder>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hfDescription" runat="server" Value='<%# Eval("DocumentDescription")%>' />
                                                <asp:Label runat="server" ID="lblDescription" Text='<%# "&nbsp;" + Eval("DocumentDescription")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="b_box" Width="15%" />
                                        </asp:TemplateField>
                                         <asp:TemplateField SortExpression="DocumentName">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkbtnDocumentName" runat="server" CommandArgument="DocumentName" CommandName="Sort"><span >Document Name</span></asp:LinkButton>
                                                <asp:PlaceHolder ID="placeholderDocumentName" runat="server"></asp:PlaceHolder>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hfDocumentName" runat="server" Value='<%# Eval("FileName")%>' />
                                                <asp:Label runat="server" ID="lblDocumentName" Text='<%# "&nbsp;" + Eval("FileName")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="b_box" Width="15%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="Date">
                                            ...
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hfDate" runat="server" Value='<%# Eval("CreatedDate")%>' />
                                                <asp:Label runat="server" ID="lblDate" Text='<%# "&nbsp;" + Eval("CreatedDate", "{0:MM/dd/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle CssClass="b_box" Width="15%" />
                                        </asp:TemplateField>
                                      <asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                                <span class="btn_space">
                                                    <asp:ImageButton ID="lnkbtndelete" runat="server" CommandName="del" OnClientClick="return DeleteConfirmation();"
                                                        CommandArgument='<%# Eval("DocumentId") %>' ImageUrl="~/Images/close.png" /></span>
                                            </ItemTemplate>
