<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="vLookupRepairOrderStatus.aspx.cs" Inherits="AssetManagement_vLookupRepairOrderStatus" Title="Repair Order Status" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        $().ready(function() {
            ...
            $.get('../JS/JQuery/validationMessages/commonValidationMsg.xml', function(xml) {
                ...
                $("#aspnetForm").validate({
                    rules: {
                    ctl00$ContentPlaceHolder1$txtRepairStatusName: {
                            required: true
                        }
                    },
                    messages: {
                    ctl00$ContentPlaceHolder1$txtRepairStatusName: {
                    required: replaceMessageString(objValMsg, "Required", "Repair Status name")
                        }
                    }
    ...
    <div class="form_pad">
        <div>
            ...
            <asp:DataList ID="dtlRepairStatus" runat="server" RepeatDirection="Vertical" RepeatColumns="2"
                OnItemCommand="dtlRepairStatus_ItemCommand">
                <ItemTemplate>
                                                ...
                                                <div class="form_popup_box">
                                                    ...
                                                    <div class="label_bar">
                                                        <label style="display:inline;">
                                                           Repair Status name :</label>
                                                        <asp:TextBox class="popup_input" ID="txtRepairStatusName" runat="server"></asp:TextBox>
                                                    </div>
